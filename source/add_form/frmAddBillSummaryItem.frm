...
Begin VB.Form frmAddBillSummaryItem 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddBillSummaryItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddBillSummaryItem.frx":27A2
         Column(2)       =   "frmAddBillSummaryItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddBillSummaryItem.frx":290E
         FormatStyle(2)  =   "frmAddBillSummaryItem.frx":2A6A
         FormatStyle(3)  =   "frmAddBillSummaryItem.frx":2B1A
         FormatStyle(4)  =   "frmAddBillSummaryItem.frx":2BCE
         FormatStyle(5)  =   "frmAddBillSummaryItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddBillSummaryItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddBillSummaryItem.frx":2F36
         Column(2)       =   "frmAddBillSummaryItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddBillSummaryItem.frx":30A2
         FormatStyle(2)  =   "frmAddBillSummaryItem.frx":31FE
         FormatStyle(3)  =   "frmAddBillSummaryItem.frx":32AE
         FormatStyle(4)  =   "frmAddBillSummaryItem.frx":3362
         FormatStyle(5)  =   "frmAddBillSummaryItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddBillSummaryItem.frx":34F2
      End
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddBillSummaryItem.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddBillSummaryItem.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddBillSummaryItem.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddBillSummaryItem.frx":4018
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddBillSummaryItem"
...
Dim Ri As CReceiptItem
   ...
   For Each D In m_TempCol2
      ...
      If D.Flag = "A" Then
         ...
         Ri.RECEIPT_ITEM_AMOUNT = D.TOTAL_AMOUNT
         Ri.VAT_AMOUNT = D.VAT_AMOUNT
         Ri.DOCUMENT_TYPE = D.DOCUMENT_TYPE
         Ri.DISCOUNT_AMOUNT = D.DISCOUNT_AMOUNT
