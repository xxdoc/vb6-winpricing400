...
Begin VB.Form frmAddReceiptItem 
   ...
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddChequeDocReceiptItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddChequeDocReceiptItem.frx":27A2
         Column(2)       =   "frmAddChequeDocReceiptItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddChequeDocReceiptItem.frx":290E
         FormatStyle(2)  =   "frmAddChequeDocReceiptItem.frx":2A6A
         FormatStyle(3)  =   "frmAddChequeDocReceiptItem.frx":2B1A
         FormatStyle(4)  =   "frmAddChequeDocReceiptItem.frx":2BCE
         FormatStyle(5)  =   "frmAddChequeDocReceiptItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddChequeDocReceiptItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddChequeDocReceiptItem.frx":2F36
         Column(2)       =   "frmAddChequeDocReceiptItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddChequeDocReceiptItem.frx":30A2
         FormatStyle(2)  =   "frmAddChequeDocReceiptItem.frx":31FE
         FormatStyle(3)  =   "frmAddChequeDocReceiptItem.frx":32AE
         FormatStyle(4)  =   "frmAddChequeDocReceiptItem.frx":3362
         FormatStyle(5)  =   "frmAddChequeDocReceiptItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddChequeDocReceiptItem.frx":34F2
      End
      ...
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddChequeDocReceiptItem.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddChequeDocReceiptItem.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddChequeDocReceiptItem.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddChequeDocReceiptItem.frx":4018
         ButtonStyle     =   3
      End
