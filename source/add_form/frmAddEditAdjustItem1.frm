...
Private Sub InitFormLayout()
   ...
   Call InitCheckBox(chkAvg, "คำนวณราคาเฉลี่ย")
...
Dim RealIndex As Long
   ...
   EnpAddress.TOTAL_ACTUAL_PRICE = Val(txtPrice.Text) * Val(txtQuantity.Text)
   EnpAddress.INCLUDE_UNIT_PRICE = EnpAddress.ACTUAL_UNIT_PRICE
   EnpAddress.TOTAL_INCLUDE_PRICE = EnpAddress.TOTAL_ACTUAL_PRICE
