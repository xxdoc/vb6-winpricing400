...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblHouse, MapText("คลัง"))
   ...
   Call InitOptionEx(radUp, "ปรับเพิ่ม")
   Call InitOptionEx(radDown, "ปรับลด")
   Call InitCheckBox(chkUpdatePrice, "คำนวณราคาเฉลี่ย")
   Call InitOptionEx(radNormal, "สุกรขุน")
   Call InitOptionEx(radMother, "แม่พันธ์")
