...
Begin VB.Form frmAddEditAdjustItemEx2 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditAdjustItemEx2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5730
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextBox txtActualAmount 
         ...
         _ExtentY        =   767
      End
      Begin Threed.SSCheck chkAutoPrice 
         Height          =   435
         Left            =   3810
         TabIndex        =   5
         Top             =   2490
      ...
      Begin Threed.SSCommand cmdNext 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditAdjustItemEx2.frx":08CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditAdjustItemEx2.frx":0BE4
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditAdjustItemEx2"
...
Private Sub chkAutoPrice_Click(value As Integer)
   m_HasModify = True
End Sub
...
Private Sub InitFormLayout()
   ...
   Call InitCheckBox(chkAutoPrice, MapText("คำนวณราคาจากโปรแกรม"))
   ...
   If DocumentType = 4 Then
      chkAutoPrice.value = FlagToCheck("Y")
   Else
      chkAutoPrice.value = FlagToCheck("N")
   End If
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         txtActualAmount.Text = EnpAddr.NEED_TOTAL_AMOUNT
         txtActualPrice.Text = EnpAddr.NEED_TOTAL_PRICE
         chkAutoPrice.value = FlagToCheck(EnpAddr.AUTO_PRICE)
...
'   End If
   ...
   EnpAddress.TX_TYPE = "I" 'Adjust
   EnpAddress.NEED_TOTAL_PRICE = Val(txtActualPrice.Text)
   EnpAddress.NEED_TOTAL_AMOUNT = Val(txtActualAmount.Text)
   EnpAddress.NEED_AVG_PRICE = MyDiffEx(EnpAddress.NEED_TOTAL_PRICE, EnpAddress.NEED_TOTAL_AMOUNT)
   EnpAddress.CALCULATE_FLAG = "N"
   EnpAddress.AUTO_PRICE = Check2Flag(chkAutoPrice.value)
...
Private Sub txtSumAmount_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      txtActualAmount.Text = Val(txtActualAmount.Text) + Val(txtSumAmount.Text)
      txtAddAmount.Text = txtAddAmount.Text & "+" & Val(txtSumAmount.Text)
      txtSumAmount.Text = ""
      txtSumAmount.SetFocus
   End If
End Sub
Private Sub txtSumPrice_KeyPress(KeyAscii As Integer)
   If KeyAscii = 13 Then
      txtActualPrice.Text = Val(txtActualPrice.Text) + Val(txtSumPrice.Text)
      txtAddPrice.Text = txtAddPrice.Text & "+" & Val(txtSumPrice.Text)
      txtSumPrice.Text = ""
      txtSumPrice.SetFocus
   End If
End Sub
