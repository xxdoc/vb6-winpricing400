...
Begin VB.Form frmAddEditBLImportItem 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditBLImportItem.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   8535
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextBox txtWeightAmount 
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtPackageWeight 
         Height          =   435
         Left            =   5640
         TabIndex        =   7
         Top             =   2100
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtPercentHumid 
         Height          =   435
         Left            =   1785
         TabIndex        =   11
         Top             =   3000
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtHumid 
         Height          =   435
         Left            =   5640
         TabIndex        =   12
         Top             =   3000
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtOtherWeight 
         Height          =   435
         Left            =   8760
         TabIndex        =   8
         Top             =   2070
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtSupplierWeight 
         Height          =   435
         Left            =   8760
         TabIndex        =   13
         Top             =   2970
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtPackageAmount 
         Height          =   435
         Left            =   1785
         TabIndex        =   6
         Top             =   2100
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtPackageAmount1 
         Height          =   435
         Left            =   1785
         TabIndex        =   9
         Top             =   2550
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextLookup uctlExpense1 
         Height          =   435
         Left            =   1785
         TabIndex        =   20
         Top             =   5250
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextLookup uctlExpense2 
         Height          =   435
         Left            =   1785
         TabIndex        =   22
         Top             =   5700
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtExpense1 
         Height          =   435
         Left            =   8520
         TabIndex        =   21
         Top             =   5220
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtExpense2 
         Height          =   435
         Left            =   8520
         TabIndex        =   23
         Top             =   5640
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtNetPrice 
         Height          =   435
         Left            =   1785
         TabIndex        =   24
         Top             =   6150
      ...
      Begin prjFarmManagement.uctlTextBox txtTotalWeight 
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtExtraName 
         Height          =   435
         Left            =   5640
         TabIndex        =   10
         Top             =   2550
         ...
         _extenty        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtPartSupplierName 
         Height          =   435
         Left            =   7200
         TabIndex        =   63
         Top             =   720
      ...
      Begin Threed.SSCommand cmdLoadWeight 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditBLImportItem.frx":08CA
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdPartItem 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditBLImportItem.frx":0BE4
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdLayout 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditBLImportItem.frx":0EFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditBLImportItem.frx":1218
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditBLImportItem"
...
Public TempWeight As Collection
...
'   txtPercentHumid.Enabled = False
   ...
   Call InitMainButton(cmdLoadWeight, MapText("โหลด"))
End Sub
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         uctlLayoutLookup.MyCombo.ListIndex = IDToListIndex(uctlLayoutLookup.MyCombo, EnpAddr.PACKAGING_ID)
         txtPartSupplierName.Text = EnpAddr.PART_SUPPLIER_NAME
...
Dim CW As CWeight
   ...
   frmAddWeight.SupplierCode = SupplierCode
   frmAddWeight.DocumentType = DocumentType
   frmAddWeight.DocumentDate = DocumentDate
   'Set frmAddWeight.TempCollection = m_BillingDoc.SupItems
   frmAddWeight.ShowMode = frmAddEditBLImportItem.ShowMode
...
Dim TempPi As CPartItem
   ...
   EnpAddress.PART_SUPPLIER_NAME = txtPartSupplierName.Text 'ADD 2016-03-09
   EnpAddress.PART_NOTE = txtNote.Text  'ADD 2016-03-23
   ...
   Set TempPi = GetObject("", m_Parts, Trim(str(EnpAddress.PART_ITEM_ID)))
   EnpAddress.UNIT_NAME = TempPi.UNIT_NAME
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Case 100
         cmdLoadWeight.Visible = True
      Case Else
         cmdLoadWeight.Visible = False
      End Select
...
Private Sub txtEntryWeight_Change()
   ...
   txtQuantity.Text = txtWeightAmount.Text
   m_HasModify = True
End Sub
...
Private Sub txtPartSupplierName_Change()
   m_HasModify = True
End Sub
