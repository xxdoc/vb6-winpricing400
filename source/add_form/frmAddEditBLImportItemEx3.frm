...
Begin VB.Form frmAddEditBLImportItemEx3 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditBLImportItemEx3.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5370
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditBLImportItemEx3.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditBLImportItemEx3"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblPartType, MapText("ประเภทของใช้ทั่วไป"))
   Call InitNormalLabel(lblPart, MapText("ของใช้ทั่วไป"))
