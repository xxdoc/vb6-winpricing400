...
'   End If
   ...
   If DocumentType = WAITING_CHEQUE Then
      Call CashDocPost2BillingDoc(m_CashDoc, BD, 15000)        ' ใบสร้างจากใบเช็ครอจ่าย
   End If
...
'         frmAddEditCashTran2.HeaderText = MapText("เพิ่ม" & "รายการถอนเงิน")
...
'         frmAddEditCashTran3.HeaderText = MapText("เพิ่ม" & "รายการถอนเงิน/โอนเงิน")
...
'         frmAddEditCashTran4.HeaderText = MapText("เพิ่ม" & "รายการโอนเงินระหว่างบัญชี")
...
'         Set frmAddEditCashTran3.TempCollection = m_CashDoc.CashTranItems
'         frmAddEditCashTran3.ShowMode = SHOW_ADD
'         frmAddEditCashTran3.HeaderText = MapText("เพิ่ม" & "รายการฝากเงิน/โอนเงิน")
'         Load frmAddEditCashTran3
'         frmAddEditCashTran3.Show 1
'
'         OKClick = frmAddEditCashTran3.OKClick
...
'         frmAddEditCashTran6.HeaderText = MapText("เพิ่ม" & "รายการเบิกเงินสดย่อย")
...
'      frmAddEditJournalItem.HeaderText = "เพิ่มรายการสมุดรายวัน"
...
'         Set frmAddEditCashTran2.TempCollection = m_CashDoc.TransferItems
'         frmAddEditCashTran2.HeaderText = MapText("แก้ไข" & "รายการถอน")
...
'         Set frmAddEditCashTran3.TempCollection = m_CashDoc.CashTranItems
'         frmAddEditCashTran3.HeaderText = MapText("แก้ไข" & "รายการถอนเงิน/โอนเงิน")
...
'         Set frmAddEditCashTran4.TempCollection = m_CashDoc.TransferItems
'         frmAddEditCashTran4.HeaderText = MapText("แก้ไข" & "รายการโอนระหว่างบัญชี")
...
'         frmAddEditCashTran3.ID = ID
'         Set frmAddEditCashTran3.TempCollection = m_CashDoc.CashTranItems
'         frmAddEditCashTran3.HeaderText = MapText("แก้ไข" & "รายการฝากเงิน/โอนเงิน")
'         frmAddEditCashTran3.ShowMode = SHOW_EDIT
'         Load frmAddEditCashTran3
'         frmAddEditCashTran3.Show 1
'
...
'         Set frmAddEditCashTran6.TempCollection = m_CashDoc.CashTranItems
'         frmAddEditCashTran6.HeaderText = MapText("แก้ไข" & "รายการเบิกเงินสดย่อย")
...
'      frmAddEditJournalItem.HeaderText = "แก้ไขรายการสมุดรายวัน"
...
Private Sub InitFormLayout()
   ...
   If DocumentType = CASH_PITTYCASH Then
      Call InitNormalLabel(lblEmployee, MapText("ผู้เบิก"))
      ...
      Call InitNormalLabel(lblIn, MapText("รวมใช้จริง"))
      Call InitNormalLabel(lblOut, MapText("รวมเบิก"))
      Call InitNormalLabel(lblLeft, MapText("คงเหลือคืน"))
   ElseIf DocumentType = POST_CHEQUE Then
   ...
   ElseIf DocumentType = WAITING_CHEQUE Or DocumentType = PASSED_CHEQUE Then
      Call InitNormalLabel(lblEmployee, MapText("ผู้จ่ายเช็ค"))
      uctlCustomerLookup.Enabled = False
      uctlBankLookup.Enabled = False
      uctlBankBranchLookup.Enabled = False
      uctlBankAccountLookup.Enabled = False
   ...
   ElseIf DocumentType = CASH_PITTYCASH Then
      Set T = TabStrip1.Tabs.add()
      T.Caption = MapText("รายการเบิก")
      T.Tag = DocumentType & "-1"
   
      Set T = TabStrip1.Tabs.add()
      T.Caption = MapText("รายการเคลียร์")
      T.Tag = DocumentType & "-CLR"
   ElseIf DocumentType = CASH_TRANSFER Then
      Set T = TabStrip1.Tabs.add()
      T.Caption = MapText("รายการโอนเงิน")
      T.Tag = DocumentType & "-1"
   ElseIf DocumentType = CASH_WITHDRAW Then
      Set T = TabStrip1.Tabs.add()
      T.Caption = MapText("รายการถอนเงิน")
      T.Tag = DocumentType & "-1"
   ElseIf DocumentType = CASH_WHTHDRAW2 Then
      Set T = TabStrip1.Tabs.add()
      T.Caption = MapText("รายการถอนเงิน/โอนเงิน")
      T.Tag = DocumentType & "-1"
   ElseIf DocumentType = CASH_DEPOSIT2 Then
      Set T = TabStrip1.Tabs.add()
      T.Caption = MapText("รายการฝากเงิน/โอนเงิน")
      T.Tag = DocumentType & "-1"
   ElseIf DocumentType = POST_CHEQUE Then
      Set T = TabStrip1.Tabs.add()
   ...
   ElseIf DocumentType = WAITING_CHEQUE Then
      Set T = TabStrip1.Tabs.add()
      T.Caption = MapText("รายการเช็ครอจ่าย")
      T.Tag = DocumentType & "-1"
   ElseIf DocumentType = PASSED_CHEQUE Then
      Set T = TabStrip1.Tabs.add()
      T.Caption = MapText("รายการที่ผ่านแล้ว")
      T.Tag = DocumentType & "-1"
   End If

'   Set T = TabStrip1.Tabs.add()
'   T.Caption = MapText("รายการสมุดรายวัน")
