...
Begin VB.Form frmAddEditReceipt 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditCheque.frx":27A2
         Column(2)       =   "frmAddEditCheque.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditCheque.frx":290E
         FormatStyle(2)  =   "frmAddEditCheque.frx":2A6A
         FormatStyle(3)  =   "frmAddEditCheque.frx":2B1A
         FormatStyle(4)  =   "frmAddEditCheque.frx":2BCE
         FormatStyle(5)  =   "frmAddEditCheque.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddEditCheque.frx":2D5E
      End
      ...
      Begin Threed.SSFrame SSFrame2 
         ...
         Begin Threed.SSCommand cmdPvNo 
            ...
            _Version        =   131073
            MousePointer    =   99
            MouseIcon       =   "frmAddEditCheque.frx":2F36
            ButtonStyle     =   3
         End
      ...
      Begin Threed.SSCommand cmdCustomer 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditCheque.frx":3250
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAuto 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditCheque.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditCheque.frx":3884
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditCheque.frx":3B9E
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditCheque.frx":3EB8
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditCheque.frx":41D2
         ButtonStyle     =   3
      End
