...
Begin VB.Form frmAddEditChequeItemAmount 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextBox txtItemAmount 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtCnDnAmount 
         Height          =   435
         Left            =   1860
         TabIndex        =   3
         Top             =   2370
...
Dim X As Double
   ...
   If Flag Then
      txtLotNo.Text = BillingDoc.GetFieldValue("CHEQUE_NO")
      uctlChequeDate.ShowDate = BillingDoc.GetFieldValue("CHEQUE_DATE")
      txtItemAmount.Text = FormatNumber(BillingDoc.GetFieldValue("CHEQUE_AMOUNT"))
      m_HasModify = True
   End If
...
'   End If
   ...
   Call BillingDoc.SetFieldValue("TEMP_FEE_AMOUNT", Val(txtCnDnAmount.Text))
   BillingDoc.Flag = "A"
