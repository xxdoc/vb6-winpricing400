...
Begin VB.Form frmAddEditCustomerAccFol 
   Caption         =   "Form1"
   ClientHeight    =   3345
   ClientLeft      =   120
   ClientTop       =   450
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditCustomerAccFol.frx":0000
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditCustomerAccFol"
...
Private m_CustomerAccFol As CAccFol
...
Private Sub Form_Load()
   ...
   Set m_CustomerAccFol = New CAccFol
...
Dim itemcount As Long
   ...
   If Flag Then
      ...
      Dim AccFol As CAccFol
         Set AccFol = TempCollection.Item(ID)

      
       uctlDate.ShowDate = AccFol.FOL_DATE
        txtDesc.Text = AccFol.FOL_NOTE
        chkStatusCustomer.Value = FlagToCheck(AccFol.CANCEL_FLAG)
      End If
   End If
...
'   End If
   ...
   If ShowMode = SHOW_ADD Then
      ...
      Call TempCollection.add(AccFol)
   Else
      Set AccFol = TempCollection.Item(ID)
  ...
  AccFol.FOL_DATE = uctlDate.ShowDate
  AccFol.FOL_NOTE = txtDesc.Text
  AccFol.CANCEL_FLAG = Check2Flag(chkStatusCustomer.Value)
