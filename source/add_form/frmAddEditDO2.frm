...
Begin VB.Form frmAddEditDO2 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditDO2.frx":27A2
         Column(2)       =   "frmAddEditDO2.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditDO2.frx":290E
         FormatStyle(2)  =   "frmAddEditDO2.frx":2A6A
         FormatStyle(3)  =   "frmAddEditDO2.frx":2B1A
         FormatStyle(4)  =   "frmAddEditDO2.frx":2BCE
         FormatStyle(5)  =   "frmAddEditDO2.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddEditDO2.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdEditCon 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDO2.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdAuto 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDO2.frx":3250
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdCustomer 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDO2.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDO2.frx":3884
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDO2.frx":3B9E
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDO2.frx":3EB8
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditDO2"
...
Dim TempUserName As String
   ...
   If Not VerifyDate(lblDueDate, uctlDueDate, True) Then
      Exit Function
   End If
'    If Not VerifyDate(lblShipment, uctlShipDate, False) Then
'      Exit Function
'   End If
 If chkPostFlag.Value = ssCBChecked And (m_BillingDoc.POST_FLAG = "" Or m_BillingDoc.POST_FLAG = "N") Then
   Dim Cf As String
   Cf = MsgBox("คุณแน่ใจหรือไม่ที่จะให้เอกสารนี้สมบูรณ์ เพื่อความแน่ใจโปรดตรวจสอบอีกครั้ง", vbYesNo, "ยืนยัน")
   If Cf = vbNo Then
      SaveData = True
      Exit Function
   End If
...
'   End If
   ...
   If TypeSale = 1 Then
      m_BillingDoc.REF = "ขายอื่นๆ"
      m_BillingDoc.SUCCESS_FLAG = "C"
   Else
...
Private Sub chkPostFlag_Click(Value As Integer)
   m_HasModify = True
End Sub
Private Function TempCol(Optional Dt As Long = 1) As Collection
Dim Di As CDoItem
Dim Di2 As CDoItem
...
For Each Di In m_BillingDoc.DoItems
   ...
   Set Di2 = New CDoItem
   Call Di2.CopyObject(1, Di)
   If Dt = 2004 Then
      Call TempCol.add(Di2, Trim(str(Di2.PO_ID) & "-" & str(Di2.PART_ITEM_ID) & "-" & str(Di2.FEATURE_ID)))
   Else
      Call TempCol.add(Di2, Trim(str(Di2.PO_ID) & "-" & str(Di2.PART_ITEM_ID)))
   End If
   Set Di2 = Nothing
Next Di
End Function
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      End If
       ...
       If lMenuChosen = 1 Then
         If Area = 1 Then
            frmAddEditDoItem2.AccountID = cboAccount.ItemData(cboAccount.ListIndex)
         End If
      ...
      ElseIf lMenuChosen = 9 Then
         ...
         ElseIf lMenuChosen = 11 Then
            Set frmAddSOItem.m_TempCol2 = TempCol(2004)
            Set frmAddSOItem.T_CBillingDoc = m_BillingDoc
            Set frmAddSOItem.TempCollection = m_BillingDoc.DoItems
            frmAddSOItem.Area = 6
            frmAddSOItem.DOCUMENT_TYPE = 2004
            frmAddSOItem.DocumentDate = uctlDocumentDate.ShowDate
            frmAddSOItem.CustomerID = uctlCustomerLookup.MyCombo.ItemData(Minus2Zero(uctlCustomerLookup.MyCombo.ListIndex))
            frmAddSOItem.CustomerCode = uctlCustomerLookup.MyTextBox.Text
            frmAddSOItem.ShowMode = SHOW_ADD
            frmAddSOItem.HeaderText = MapText("เพิ่มรายการใบส่งของจากใบขึ้นอาหาร อื่นๆ")
...
'                  TempStr3 = Format(1, TempStr3) 'เริ่มจาก 1 เสมอ
'                  m_BillingDoc.RUNNING_NO = 1
'                  GetDocumentNo = TempStr2 & "-" & Format(Cd.GetFieldValue("RUNNING_NO") + DocAdd, TempStr3) & "-" & TempStr
'               Else
''                  GetDocumentNo = GetDocumentNo & Format(Cd.GetFieldValue("RUNNING_NO") + 1 + DocAdd, TempStr3)
'                  GetDocumentNo = TempStr2 & "-" & Format(Cd.GetFieldValue("RUNNING_NO") + 1 + DocAdd, TempStr3) & "-" & TempStr
'                 m_BillingDoc.RUNNING_NO = Cd.GetFieldValue("RUNNING_NO") + 1 + DocAdd
...
'      frmAddEditDoItem.DeliveryCostFlag = EditDeliveryCostFlag
      ...
      frmAddEditDoItem2.PRICE_THINK_TYPE = m_BillingDoc.PRICE_THINK_TYPE
...
Private Sub cmdEditCon_Click()
   ...
   Else
      ...
      Exit Sub
   End If
   If m_BillingDoc.DoItems.Count > 0 Then 'ห้ามใช้ CountItem เนื่องจาก จะเช็คยอดรายการที่มาจาก database จริงๆ กันการหลอกลบรายการ แล้ว แก้ไขเงื่อนไขได้
'      glbErrorLog.LocalErrorMsg = MapText("ไม่สามารถเปลี่ยนแปลงเงื่อนไขการขายได้ เนื่องจากมีรายการใบส่งสินค้าแล้ว")
       glbErrorLog.LocalErrorMsg = MapText("เนื่องจากมีรายการใบส่งสินค้าแล้ว คุณจะต้องเข้าไปแก้ไขทุกรายการเพื่อเปลี่ยนแปลงราคาใหม่")
      glbErrorLog.ShowUserError
'      Exit Sub
   End If
...
'      frmAddEditTransport.ID = ID
     ...
     frmAddEditTransport.DELIVERY_CUS_ITEM_ID = m_BillingDoc.DELIVERY_CUS_ITEM_ID
   ...
   ElseIf lMenuChosen = 3 Then
      ...
      frmAddEditTransport.BillingdocID = m_BillingDoc.BILLING_DOC_ID
      frmAddEditTransport.CUSTOMER_ID = uctlCustomerLookup.MyCombo.ItemData(Minus2Zero(uctlCustomerLookup.MyCombo.ListIndex))
'      Set frmAddEditTransport.m_ExDeliveryCostItem = m_ExDeliveryCostItem
      Set frmAddEditTransport.TempCollection = m_BillingDoc.DoItems
      Set frmAddEditTransport.TempCollection2 = m_BillingDoc.BillTransport
      frmAddEditTransport.HeaderText = MapText("เพิ่มรายการค่าขนส่งสินค้า")
     frmAddEditTransport.ShowMode = SHOW_EDIT
      ...
      End If
   ElseIf lMenuChosen = 5 Then
      If Not ConfirmDelete("ค่าขนส่งรายการนี้") Then
        Exit Sub
      End If
...
'   End If
   ...
   If Not Report Is Nothing Then
      ...
      If chkDlcShow.Value = ssCBChecked Then
         Call Report.AddParam(True, "notShowDlc")
      Else
         Call Report.AddParam(False, "notShowDlc")
      End If
...
Private Sub InitFormLayout()
   ...
   If Area = 1 Then
      ...
      lblDeliveryCusLookup.Visible = True
      uctlDeliveryCusLookup.Visible = True
      lblRateType.Visible = True
      cboRateType.Visible = True
   
      uctlDeliveryCusLookup.Enabled = False
      cboRateType.Enabled = False
   ElseIf Area = 2 Then
   ...
   Call InitCheckBox(chkDlcShow, "ไม่แสดงสถานที่จัดส่ง")
...
'   txtTotalDiscount.Enabled = False
   ...
   Call txtTempDONo.SetTextLenType(TEXT_STRING, glbSetting.DESC_TYPE)
...
Dim RealIndex As Long
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      Values(8) = CR.PO_NO
      Values(9) = CR.USER_APPLOVE_PRICE
   ElseIf TabStrip1.SelectedItem.Index = 2 Then
...
Private Sub TabStrip1_Click()
   ...
   SSFrame3.Top = GridEX1.Top ' 5160
   SSFrame3.Left = 150
   SSFrame3.Visible = False
   
   SSFrame4.Top = GridEX1.Top '5160
   SSFrame4.Left = 150
   SSFrame4.Visible = False
...
'      txtPayment.Text = uctlDeliveryCusLookup.MyCombo.Text
'   End If
End Sub
...
Static OldCusId As Long
   ...
   If CustomerID > 0 Then
      ...
      Call LoadDeliveryCus(uctlDeliveryCusLookup.MyCombo, m_DeliveryCus, CustomerID) 'LOAD สถานที่จัดส่ง
      Set uctlDeliveryCusLookup.MyCollection = m_DeliveryCus
     
     Set TempD2 = GetObject("CCustomer", m_Customers, Trim(str(CustomerID)), False)
