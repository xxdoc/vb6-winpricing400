...
Begin VB.Form frmAddEditDoItem2 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditDOItem2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   9420
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdEditCon 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDOItem2.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditDoItem2"
...
Public EditConditionFlag As Boolean
...
Private Sub cmdEditCon_Click()
   ...
   End If
   EditPriceFlag = True
   txtPricePerPack.Enabled = False 'True
   txtDiscountPerPack.Enabled = False 'True
End Sub
...
Private Sub InitFormLayout()
   ...
   Call InitMainButton(cmdEditCon, MapText("แก้ไขราคา"))
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         Else
            ...
            Call ShowConfigFlag(Di.CONFIG_CODE)
             ...
             Call LoadSumWithDoItemId(cboSumWithDoItemId, TempCollection, , Di.PART_ITEM_ID)
...
If EditConditionFlag Then 'ถ้าเป็นการเปลี่ยนแปลงเงื่อนไข ที่ฟอร์มแม่ ก็สั่งให้ ฟอร์มลูกบันทึกอัตโนมัติด้วย
   m_HasModify = True
End If
   ...
   Else
      ...
      Di.RATE_TYPE = PRICE_THINK_TYPE ' cboRateType.ItemData(Minus2Zero(cboRateType.ListIndex))
...
'      End If
      ...
      Call LoadFeature(uctlFeatureLookup.MyCombo, m_Features, , , "Y", "Y")
