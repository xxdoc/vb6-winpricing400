...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblSalePrice, MapText("ราคาขาย"))
   Call InitNormalLabel(lblPriceDate, MapText("ราคา ณ วันที่"))
   Call InitNormalLabel(lblBuyPrice, MapText("ราคาซื้อ"))
   Call InitNormalLabel(Label1, MapText("บาท"))
   Call InitNormalLabel(Label2, MapText("บาท"))
   Call InitNormalLabel(lblSellType, MapText("ประเภทราคาทอง"))
   Call InitNormalLabel(lblEmployee, MapText("ผู้ทำรายการ"))
