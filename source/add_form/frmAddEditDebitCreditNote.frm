...
Begin VB.Form frmAddEditDebitCreditNote 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddEditDebitCreditNote.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditDebitCreditNote.frx":27A2
         Column(2)       =   "frmAddEditDebitCreditNote.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditDebitCreditNote.frx":290E
         FormatStyle(2)  =   "frmAddEditDebitCreditNote.frx":2A6A
         FormatStyle(3)  =   "frmAddEditDebitCreditNote.frx":2B1A
         FormatStyle(4)  =   "frmAddEditDebitCreditNote.frx":2BCE
         FormatStyle(5)  =   "frmAddEditDebitCreditNote.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddEditDebitCreditNote.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdCustomer 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDebitCreditNote.frx":2F36
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAuto 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDebitCreditNote.frx":3250
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDebitCreditNote.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDebitCreditNote.frx":3884
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDebitCreditNote.frx":3B9E
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditDebitCreditNote.frx":3EB8
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditDebitCreditNote"
...
Private Function GenerateAccessCode() As String
...
Dim TempStr2 As String
   ...
   GenerateAccessCode = TempStr1 & TempStr2
End Function
...
Dim Ivd As CInventoryDoc
   ...
   If Area = 1 Then
      ...
      If DebitCreditType = 1 Then
         m_BillingDoc.DOCUMENT_TYPE = 4 'ใบเพิ่มหนี้
      ElseIf DebitCreditType = 2 Then
         m_BillingDoc.DOCUMENT_TYPE = 3 'ใบลดหนี้
      End If
   ElseIf Area = 2 Then
      ...
      If DebitCreditType = 1 Then
         m_BillingDoc.DOCUMENT_TYPE = 10 'ใบเพิ่มหนี้
      ElseIf DebitCreditType = 2 Then
         m_BillingDoc.DOCUMENT_TYPE = 9 'ใบลดหนี้
      End If
   End If
   
   If ShowMode = SHOW_EDIT Then
      If Area = 1 Then
         If Not VerifyAccessRight("LEDGER_SELL" & "_" & m_BillingDoc.DOCUMENT_TYPE & "_" & "EDIT", "แก้ไข") Then
            Call EnableForm(Me, True)
            Exit Function
         End If
      ElseIf Area = 2 Then
         If Not VerifyAccessRight("LEDGER_BUY" & "_" & m_BillingDoc.DOCUMENT_TYPE & "_" & "EDIT", "แก้ไข") Then
            Call EnableForm(Me, True)
            Exit Function
         End If
      End If
...
'   End If
   ...
   m_BillingDoc.INVENTORY_DOC_ID = -1
...
Dim oMenu As cPopupMenu
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      lMenuChosen = oMenu.Popup("ใบส่งสินค้า")
      
      If lMenuChosen = 0 Then
         Exit Sub
      End If
      
      frmAddDebitCreditNoteItem.Area = Area
      If lMenuChosen = 1 Then
         frmAddDebitCreditNoteItem.InvoiceDOType = 1 'DO
      ElseIf lMenuChosen = 3 Then
         frmAddDebitCreditNoteItem.InvoiceDOType = 2 'Invoice
      End If
      If Area = 1 Then
         frmAddDebitCreditNoteItem.AccountID = cboAccount.ItemData(Minus2Zero(cboAccount.ListIndex))
      ElseIf Area = 2 Then
         frmAddDebitCreditNoteItem.AccountID = uctlCustomerLookup.MyCombo.ItemData(Minus2Zero(uctlCustomerLookup.MyCombo.ListIndex))
      End If
      Set frmAddDebitCreditNoteItem.TempCollection = m_BillingDoc.ReceiptItems
      frmAddDebitCreditNoteItem.ShowMode = SHOW_ADD
      If DebitCreditType = 1 Then
         frmAddDebitCreditNoteItem.HeaderText = MapText("เพิ่มรายการใบเพิ่มหนี้")
      ElseIf DebitCreditType = 2 Then
         frmAddDebitCreditNoteItem.HeaderText = MapText("เพิ่มรายการใบลดหนี้")
      End If
      Load frmAddDebitCreditNoteItem
      frmAddDebitCreditNoteItem.Show 1

      OKClick = frmAddDebitCreditNoteItem.OKClick

      Unload frmAddDebitCreditNoteItem
      Set frmAddDebitCreditNoteItem = Nothing
...
Dim No As String
   ...
   If Trim(txtDocumentNo.Text) = "" Then
      If DebitCreditType = 1 Then
         Call glbDatabaseMngr.GenerateNumber(DBN_NUMBER, No, glbErrorLog)
      ElseIf DebitCreditType = 2 Then
         Call glbDatabaseMngr.GenerateNumber(CDN_NUMBER, No, glbErrorLog)
      End If
...
Dim ReportMode As Long
   ...
   Set oMenu = New cPopupMenu
   lMenuChosen = oMenu.AddMenu(glbGuiConfigs.CdnDbnPrintMenuItems)
   If lMenuChosen = 0 Then
      Exit Sub
   End If
...
'   End If
   ...
   If lMenuChosen = 1 Then
      ReportKey = "CReportNormalDBCDN001"
      
      Set Report = New CReportNormalDBCDN001
      ReportFlag = True
   ElseIf lMenuChosen = 2 Then
      ...
      If DebitCreditType = 1 Then
      HeaderText = MapText("ใบเพิ่มหนี้")
   ElseIf DebitCreditType = 2 Then
      HeaderText = MapText("ใบลดหนี้")
   End If
   ...
   If Not Report Is Nothing Then
      Call Report.AddParam(Area, "AREA_TYPE")
      ...
      If DebitCreditType = 1 Then
      Call Report.AddParam(MapText("ใบเพิ่มหนี้"), "REPORT_HEADER")
   ElseIf DebitCreditType = 2 Then
      Call Report.AddParam(MapText("ใบลดหนี้"), "REPORT_HEADER")
   End If
...
Dim Sum2 As Double
   ...
   For Each II In m_BillingDoc.ReceiptItems
      If II.Flag <> "D" Then
         Sum1 = Sum1 + II.DEBIT_CREDIT_AMOUNT
         Sum2 = Sum2 + II.RECEIPT_ITEM_AMOUNT
      End If
   Next II

   txtNetTotal.Text = FormatNumber(Sum1)
   txtTotalPrice.Text = FormatNumber(Sum2)
End Sub
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblTotalPrice, MapText("ยอดหนี้รวม"))
   Call InitNormalLabel(Label1, MapText("บาท"))
   
   If DebitCreditType = 1 Then
      Call InitNormalLabel(lblNetTotal, MapText("ยอดเพิ่มหนี้รวม"))
      Call InitNormalLabel(lblDocumentNo, MapText("เลขที่ใบเพิ่มหนี้"))
   ElseIf DebitCreditType = 2 Then
      Call InitNormalLabel(lblNetTotal, MapText("ยอดลดหนี้รวม"))
      Call InitNormalLabel(lblDocumentNo, MapText("เลขที่ใบลดหนี้"))
   End If
...
'   End If
   ...
   If DebitCreditType = 1 Then
      TabStrip1.Tabs.add().Caption = MapText("รายการใบเพิ่มหนี้")
   ElseIf DebitCreditType = 2 Then
      TabStrip1.Tabs.add().Caption = MapText("รายการใบลดหนี้")
   End If
...
Dim RealIndex As Long
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      Values(6) = FormatNumber(CR.RECEIPT_ITEM_AMOUNT)
      If Area = 1 Then
         If CR.DOCUMENT_TYPE = 1 Then
            Values(7) = "ใบส่งสินค้า"
         ElseIf CR.DOCUMENT_TYPE = 5 Then
            Values(7) = "ใบกำกับภาษี"
         End If
      ElseIf Area = 2 Then
        If CR.DOCUMENT_TYPE = 100 Then
            Values(7) = "ใบรับเข้าวัตถุดิบ"                     'ใบรับเข้าวัตถุดิบ
         ElseIf CR.DOCUMENT_TYPE = 101 Then
            Values(7) = "ใบรับเข้าวัสดุอุปกรณ์"                     'ใบรับเข้าวัสดุอุปกรณ์
         ElseIf CR.DOCUMENT_TYPE = 102 Then
            Values(7) = "ใบรับเข้าจ่ายออกวัสดุอุปกรณ์"                     'ใบรับเข้าจ่ายออกวัสดุอุปกรณ์
         ElseIf CR.DOCUMENT_TYPE = 103 Then
            Values(7) = "ใบรับเข้าทั่วไป"                     'ใบรับเข้าทั่วไป
         End If
      End If
      Values(8) = CR.DO_ID
   ElseIf TabStrip1.SelectedItem.Index = 2 Then
