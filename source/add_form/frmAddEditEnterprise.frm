...
Begin VB.Form frmAddEditEnterprise 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextBox txtShortName 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtBranchCode 
         Height          =   435
         Left            =   2100
         TabIndex        =   2
         Top             =   1890
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtBranchName 
         Height          =   435
         Left            =   2100
         TabIndex        =   3
         Top             =   2340
...
Dim ItemCount As Long
   ...
   If ItemCount > 0 Then
      ...
      m_Enterprise.ENTERPRISE_ID = m_Enterprise.ENTERPRISE_ID
      
      txtTaxID.Text = m_Enterprise.TAX_ID
      txtBranchCode.Text = m_Enterprise.BRANCH_CODE
      txtBranchName.Text = m_Enterprise.BRANCH_NAME
      ...
      If (Not m_Enterprise.EnpNames Is Nothing) And (m_Enterprise.EnpNames.Count > 0) Then
         ...
         txtShortName.Text = NAME.SHORT_NAME
      Else
         txtName.Text = ""
         txtShortName.Text = ""
      End If
...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = MapText("ข้อมูลบริษัท")
 ...
 If Not glbGuiConfigs.VerifyGuiConfig("ENTERPRISE_INFO_EDIT") Then
