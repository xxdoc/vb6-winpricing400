...
Begin VB.Form frmAddEditGoldDoItem2 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditGoldDOItem2.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdPriceSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditGoldDOItem2.frx":08CA
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditGoldDOItem2.frx":0BE4
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditGoldDoItem2"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblWage, MapText("ค่าน้ำกรด/หน่วย"))
