...
Begin VB.Form frmAddEditInventoryWH 
   BackColor       =   &H80000000&
   ClientHeight    =   8520
   ClientLeft      =   120
   ClientTop       =   405
   ClientWidth     =   11910
   Icon            =   "frmAddEditInventoryWH.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   8520
   ScaleWidth      =   11910
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditInventoryWH.frx":27A2
         Column(2)       =   "frmAddEditInventoryWH.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditInventoryWH.frx":290E
         FormatStyle(2)  =   "frmAddEditInventoryWH.frx":2A6A
         FormatStyle(3)  =   "frmAddEditInventoryWH.frx":2B1A
         FormatStyle(4)  =   "frmAddEditInventoryWH.frx":2BCE
         FormatStyle(5)  =   "frmAddEditInventoryWH.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddEditInventoryWH.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryWH.frx":2F36
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryWH.frx":3250
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryWH.frx":356A
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmAddEditInventoryWH"
...
Private Sub TabStrip1_Click()
   cmdAdd.Enabled = (TabStrip1.SelectedItem.Index = 3)
   cmdEdit.Enabled = (TabStrip1.SelectedItem.Index = 3)
   cmdDelete.Enabled = (TabStrip1.SelectedItem.Index = 3)
   If TabStrip1.SelectedItem.Index = 1 Then
      Call InitGrid1
