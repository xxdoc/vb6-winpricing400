...
Begin VB.Form frmAddEditInventoryWhDoc3 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddEditInventoryWhDoc3.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditInventoryWhDoc3.frx":27A2
         Column(2)       =   "frmAddEditInventoryWhDoc3.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditInventoryWhDoc3.frx":290E
         FormatStyle(2)  =   "frmAddEditInventoryWhDoc3.frx":2A6A
         FormatStyle(3)  =   "frmAddEditInventoryWhDoc3.frx":2B1A
         FormatStyle(4)  =   "frmAddEditInventoryWhDoc3.frx":2BCE
         FormatStyle(5)  =   "frmAddEditInventoryWhDoc3.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddEditInventoryWhDoc3.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdAuto 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryWhDoc3.frx":2F36
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdPrint 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryWhDoc3.frx":3250
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryWhDoc3.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryWhDoc3.frx":3884
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditInventoryWhDoc3.frx":3B9E
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditInventoryWhDoc3"
...
Dim ItemCount As Long
   ...
   If ItemCount > 0 Then
      ...
      chkCommit.Value = FlagToCheck(m_InventoryWHDoc.COMMIT_FLAG)
      
      cmdAdd.Enabled = (m_InventoryWHDoc.COMMIT_FLAG = "N")
      cmdDelete.Enabled = (m_InventoryWHDoc.COMMIT_FLAG = "N")
      chkCommit.Enabled = (m_InventoryWHDoc.COMMIT_FLAG = "N")
      
'''      Call glbDaily.CreateTransferItems(m_InventoryWHDoc)
   End If
   If Not IsOK Then
...
'   End If
   ...
   m_InventoryWHDoc.EXCEPTION_FLAG = "Y"
   ...
   If (m_InventoryWHDoc.COMMIT_FLAG = "Y") Then
      If m_InventoryWHDoc.OLD_COMMIT_FLAG <> "Y" Then
         Call glbDaily.TriggerCommit(m_InventoryWHDoc.ImportExports)
         If Not glbDaily.VerifyStockBalance(m_InventoryWHDoc.ImportExports, glbErrorLog) Then
            Call EnableForm(Me, True)
            Exit Function
         End If
      End If
...
Dim II As CLotItem
   ...
   Set m_InventoryWHDoc.ImportExports = Nothing
   Set m_InventoryWHDoc.ImportExports = New Collection

   For Each Ti In m_InventoryWHDoc.TransferItems
      ...
      Call m_InventoryWHDoc.ImportExports.add(Ei)
      Call m_InventoryWHDoc.ImportExports.add(II)
   Next Ti
End Sub
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      If DocumentType = 2002 Then
         frmAddEditTransferItemWh.COMMIT_FLAG = m_InventoryWHDoc.COMMIT_FLAG
         Set frmAddEditTransferItemWh.TempCollection = m_InventoryWHDoc.TransferItems
         
         frmAddEditTransferItemWh.ParentShowMode = ShowMode
         frmAddEditTransferItemWh.ShowMode = SHOW_ADD
         frmAddEditTransferItemWh.DOCUMENT_TYPE = DocumentType
         frmAddEditTransferItemWh.HeaderText = MapText("เพิ่มรายการโอน")
         Load frmAddEditTransferItemWh
         frmAddEditTransferItemWh.Show 1
   
         OKClick = frmAddEditTransferItemWh.OKClick
   
         Unload frmAddEditTransferItemWh
         Set frmAddEditTransferItemWh = Nothing
   
         If OKClick Then
            Call GetTotalPrice
            
            GridEX1.ItemCount = CountItem(m_InventoryWHDoc.TransferItems)
            GridEX1.Rebind
         End If
      End If
...
Dim ID2 As Long
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      If ID1 <= 0 Then
         m_InventoryWHDoc.TransferItems.Remove (ID2)
      Else
         m_InventoryWHDoc.TransferItems.Item(ID2).Flag = "D"
      End If
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      If DocumentType = 3 Then
         ...
         frmAddEditTransferItem.COMMIT_FLAG = m_InventoryWHDoc.COMMIT_FLAG
         Set frmAddEditTransferItem.TempCollection = m_InventoryWHDoc.TransferItems
      ...
      ElseIf DocumentType = 22 Then
         frmAddEditTransferItemWh.ID = ID
         frmAddEditTransferItemWh.COMMIT_FLAG = m_InventoryWHDoc.COMMIT_FLAG
         Set frmAddEditTransferItemWh.TempCollection = m_InventoryWHDoc.TransferItems
         frmAddEditTransferItemWh.HeaderText = MapText("แก้ไขรายการโอน")
         frmAddEditTransferItemWh.ParentShowMode = ShowMode
         frmAddEditTransferItemWh.ShowMode = SHOW_EDIT
         Load frmAddEditTransferItemWh
         frmAddEditTransferItemWh.Show 1
...
Dim ClassName As String
   ...
   If Not Report Is Nothing Then
      Call Report.AddParam(m_InventoryWHDoc.INVENTORY_WH_DOC_ID, "INVENTORY_DOC_ID")
...
'
'   Sum = 0
'   For Each Ii In m_InventoryWhDoc.TransferItems
'      If Ii.Flag <> "D" Then
...
Dim RealIndex As Long
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      If m_InventoryWHDoc.TransferItems Is Nothing Then
         Exit Sub
      End If
      ...
      If m_InventoryWHDoc.TransferItems.Count <= 0 Then
         Exit Sub
      End If
      Set CR = GetItem(m_InventoryWHDoc.TransferItems, RowIndex, RealIndex)
