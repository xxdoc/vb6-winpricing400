...
Begin VB.Form frmAddEditJobPeople 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditJobPeople.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextLookup uctlPeopleLookup 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextLookup uctlPositionLookup 
         Height          =   435
         Left            =   1800
         TabIndex        =   0
         Top             =   300
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditJobPeople.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditJobPeople"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblPeople, MapText("พนักงาน"))
...
Dim itemcount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         uctlPositionLookup.MyCombo.ListIndex = IDToListIndex(uctlPositionLookup.MyCombo, Ma.POSITION_ID)
...
'        uctlTime.HR = MA.EMP_ID_HOUR
'        uctlTime.MI = MA.EMP_ID_HOURN
      End If
   End If
...
If Not VerifyDate(lblUseDate, uctlUseDate, False) Then
   ...
   Ma.POSITION_ID = uctlPositionLookup.MyCombo.ItemData(Minus2Zero(uctlPositionLookup.MyCombo.ListIndex))
   Ma.POSITION_NAME = uctlPositionLookup.MyCombo.Text
   Ma.EMP_ID = uctlPeopleLookup.MyCombo.ItemData(Minus2Zero(uctlPeopleLookup.MyCombo.ListIndex))
   Ma.LAST_NAME = ""
   Ma.LONG_NAME = uctlPeopleLookup.MyCombo.Text
   Ma.OCCUPY_DATE = uctlUseDate.ShowDate
   Ma.OCCUPY_INTERVAL = Val(uctlTextBox1.Text)
   
'   MA.EMP_ID_HOUR = uctlTime.HR
'   MA.EMP_ID_HOURN = uctlTime.MI
   If ShowMode = SHOW_ADD Then
      Ma.Flag = "A"
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call LoadPosition(uctlPositionLookup.MyCombo, m_Positions)
      Set uctlPositionLookup.MyCollection = m_Positions
      Call LoadEmployee(uctlPeopleLookup.MyCombo, m_People_combo)
      Set uctlPeopleLookup.MyCollection = m_People_combo
...
Private Sub uctlPositionLookup_Change()
Dim PositionID As Long

   PositionID = uctlPositionLookup.MyCombo.ItemData(Minus2Zero(uctlPositionLookup.MyCombo.ListIndex))
   
   Call LoadEmployee(uctlPeopleLookup.MyCombo, m_People_combo, PositionID)
   Set uctlPeopleLookup.MyCollection = m_People_combo
