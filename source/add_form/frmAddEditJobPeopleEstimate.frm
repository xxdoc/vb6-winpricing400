...
Begin VB.Form frmAddEditJobPeopleEstimate 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditJobPeopleEstimate.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3750
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditJobPeopleEstimate.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditJobPeopleEstimate"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblPeople, MapText("บุคคลากร"))
...
If Not VerifyCombo(lblPosition, cboPosition, False) Then
   ...
   MA.POSITION_ID = cboPosition.ItemData(Minus2Zero(cboPosition.ListIndex))
   MA.POSITION_NAME = cboPosition.Text
...
Dim ID As Long
   ...
   If ID <> 0 Then
   Call LoadEmployee(uctlPeopleLookup.MyCombo, m_People_combo, ID)
   End If
End Sub
