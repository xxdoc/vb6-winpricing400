...
Begin VB.Form frmAddEditPO 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddEditPO.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditPO.frx":27A2
         Column(2)       =   "frmAddEditPO.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditPO.frx":290E
         FormatStyle(2)  =   "frmAddEditPO.frx":2A6A
         FormatStyle(3)  =   "frmAddEditPO.frx":2B1A
         FormatStyle(4)  =   "frmAddEditPO.frx":2BCE
         FormatStyle(5)  =   "frmAddEditPO.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddEditPO.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdCustomer 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPO.frx":2F36
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAuto 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPO.frx":3250
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdSave 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPO.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPO.frx":3884
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPO.frx":3B9E
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPO.frx":3EB8
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditPO"
...
Dim Ivd As CInventoryDoc
   ...
   If Area = 1 Then
      ...
      m_BillingDoc.DOCUMENT_TYPE = 12 'ใบ PO
'   ElseIf Area = 2 Then
...
'      m_BillingDoc.DOCUMENT_TYPE = 7 'ใบส่งของ
   End If
...
'      lMenuChosen = oMenu.Popup("เพิ่มรายการใหม่ (ทีละรายการ)", "เพิ่มรายการใหม่ (เป็นชุด)") 'ปิดไปก่อน การตลาดบอกไม่ได้ใช่ 2018-12-25
      ...
      If lMenuChosen = 1 Then
        ...
        End If
         ...
         frmAddEditDoItem.HeaderText = MapText("เพิ่มรายการใบ PO")
      ...
      Else
         ...
         frmAddEditDoItemEx.HeaderText = MapText("เพิ่มรายการใบ PO")
...
Dim No As String
   ...
   If Trim(txtDocumentNo.Text) = "" Then
      Call glbDatabaseMngr.GenerateNumber(PO_NUMBER, No, glbErrorLog)
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      frmAddEditDoItem.COMMIT_FLAG = m_BillingDoc.COMMIT_FLAG
      Set frmAddEditDoItem.TempCollection = m_BillingDoc.DoItems
      frmAddEditDoItem.HeaderText = MapText("แก้ไขรายการใบ PO")
      frmAddEditDoItem.ParentShowMode = ShowMode
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblDocumentNo, MapText("เลขที่ใบ PO"))
   ...
   Call InitNormalLabel(lblEstimateDate, MapText("วันรับงาน"))
   Call InitNormalLabel(lblApproveDate, MapText("วันตรวจแบบ"))
   Call InitNormalLabel(lblResourceNo, MapText("ทรัพยากร"))
...
'   cmdPrint.Enabled = False
   ...
   TabStrip1.Tabs.add().Caption = MapText("รายการใบ PO")
