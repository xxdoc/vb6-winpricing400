...
Begin VB.Form frmAddEditPartItemPicture 
   BackColor       =   &H80000000&
   ...
   ClientTop       =   330
   ClientWidth     =   11910
   Icon            =   "frmAddEditPartItemPicture.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdFileName 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPartItemPicture.frx":27A2
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPartItemPicture.frx":2ABC
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmAddEditPartItemPicture"
...
Dim IsOK As Boolean
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
          Dim Di As CPartItemPicture
         
          Set Di = TempCollection.Item(id)
         
         
         
          txtPath.Text = Di.GetFieldValue("PART_ITEM_PICTURE_PATH")
...
Dim RealIndex As Long
   ...
   Call Di.SetFieldValue("PART_ITEM_PICTURE_PATH", txtPath.Text)
   Call Di.SetFieldValue("PART_ITEM_PICTURE_TYPE", PictureType)
