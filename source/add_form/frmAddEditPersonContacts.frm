...
Begin VB.Form frmAddEditPersonContacts 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditPersonContacts.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPersonContacts.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditPersonContacts"
...
Dim RealIndex As Long
   ...
   Dim Addr As CAddress
   Dim EnpAddress As CEmpAddress
   If ShowMode = SHOW_ADD Then
      Set Addr = New CAddress
      Set EnpAddress = New CEmpAddress
