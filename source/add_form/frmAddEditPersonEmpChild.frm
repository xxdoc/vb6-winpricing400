...
Begin VB.Form frmAddEditPersonEmpChild 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditPersonEmpChild.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4200
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPersonEmpChild.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditPersonEmpChild"
...
Private Sub InitFormLayout()
   ...
   Call txtNickName.SetTextLenType(TEXT_STRING, glbSetting.DESC_TYPE)
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         txtNickName.Text = Name.NICK_NAME
...
Dim RealIndex As Long
   ...
   Name.NICK_NAME = txtNickName.Text
