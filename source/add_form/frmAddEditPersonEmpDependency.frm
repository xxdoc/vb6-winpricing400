...
Begin VB.Form frmAddEditPersonEmpDependency 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditPersonEmpDependency.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditPersonEmpDependency.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditPersonEmpDependency"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblRelation, MapText("ความสัมพันธ์"))
   Call InitNormalLabel(lblBirthDate, MapText("วันเกิด"))
   Call InitNormalLabel(lblPhone, MapText("หมายเลขติดต่อ"))
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
               Dim Name As cName
         Dim D As CEmpDependency
         Set D = TempCollection.Item(ID)
         Set Name = D.Name
         
         txtName.Text = Name.LONG_NAME
         txtLastName.Text = Name.LAST_NAME
         cboRelation.ListIndex = IDToListIndex(cboRelation, D.DEPENDENCY_TYPE)
         uctlBirthDate.ShowDate = D.BIRTH_DATE
...
Dim RealIndex As Long
   ...
   If Not VerifyTextControl(lblName, txtName, False) Then
      Exit Function
   End If
   If Not VerifyCombo(lblRelation, cboRelation, False) Then
      Exit Function
   End If
   If Not VerifyDate(lblBirthDate, uctlBirthDate, True) Then
      Exit Function
   End If
   ...
   D.BIRTH_DATE = uctlBirthDate.ShowDate
   D.DEPENDENCY_TYPE = cboRelation.ItemData(Minus2Zero(cboRelation.ListIndex))
   D.DEPENDENCY_NAME = cboRelation.Text
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Me.Refresh
      DoEvents
        Call LoadDependencyType(cboRelation)
      If ShowMode = SHOW_EDIT Then
         Call QueryData(True)
