...
Dim oMenu As cPopupMenu
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      'lMenuChosen = oMenu.Popup("เพิ่มรายการใหม่ (ทีละรายการ)")
      'Use the same as PO
...
'   End If
   ...
   If Not Report Is Nothing Then
      ...
      Call Report.AddParam(MapText("ใบเสนอราคา"), "REPORT_HEADER")
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblDocumentNo, MapText("เลขที่ใบเสนอราคา"))
   ...
   Call InitNormalLabel(lblVadilityDate, MapText("วันกำหนดยื่นราคา"))
   Call InitNormalLabel(lblDelivery, MapText("วันกำหนดส่งของ"))
   Call InitNormalLabel(lblPayment, MapText("วันกำหนดชำระเงิน"))
...
'   cmdPrint.Enabled = False
   ...
   TabStrip1.Tabs.add().Caption = MapText("รายการใบเสนอราคา")
