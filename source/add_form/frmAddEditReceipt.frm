...
Begin VB.Form frmAddEditReceipt 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextLookup uctlSellByLookup 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtVatPercent 
         Height          =   435
         Left            =   1860
         TabIndex        =   13
         Top             =   3150
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtWH 
         Height          =   435
         Left            =   1860
         TabIndex        =   16
         Top             =   3600
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtVatAmount 
         Height          =   435
         Left            =   5250
         TabIndex        =   14
         Top             =   3150
      ...
      Begin prjFarmManagement.uctlTextBox txtWHAmount 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtIncludeVat 
         Height          =   435
         Left            =   9330
         TabIndex        =   15
         Top             =   3150
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtIncludeWH 
         Height          =   435
         Left            =   9330
         TabIndex        =   18
         Top             =   3600
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditReceipt.frx":3B9E
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditReceipt.frx":3EB8
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditReceipt.frx":41D2
         ButtonStyle     =   3
      End
...
Dim oMenu As cPopupMenu
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      If (ReceiptType = 3) Or (ReceiptType = 5) Then
        ...
        lMenuChosen = oMenu.Popup("เลือกจากใบกำกับภาษี", "-", "เลือกจากการชำระโดยเช็ค")
...
'      lMenuChosen = 1
      If lMenuChosen = 1 Then
         ...
         frmAddReceiptItem.DefaultTodate = uctlDocumentDate.ShowDate
         
         frmAddReceiptItem.ShowMode = SHOW_ADD
         frmAddReceiptItem.HeaderText = MapText("เพิ่มรายการใบเสร็จ(ใบกำกับภาษี)")
      ...
      ElseIf lMenuChosen = 3 Then
       ...
       frmAddChequeDocReceiptDocItem.Area = Area
         frmAddChequeDocReceiptDocItem.ReceiptType = ReceiptType
         If Area = 1 Then
            frmAddChequeDocReceiptDocItem.AccountID = cboAccount.ItemData(Minus2Zero(cboAccount.ListIndex))
         ElseIf Area = 2 Then
            frmAddChequeDocReceiptDocItem.AccountID = uctlCustomerLookup.MyCombo.ItemData(Minus2Zero(uctlCustomerLookup.MyCombo.ListIndex))
         End If
         Set frmAddChequeDocReceiptDocItem.TempCollection = m_BillingDoc.ReceiptItems
           
         
         frmAddChequeDocReceiptDocItem.ShowMode = SHOW_ADD
         frmAddChequeDocReceiptDocItem.HeaderText = MapText("เพิ่มรายการใบเสร็จ(เช็ค)")
         Load frmAddChequeDocReceiptDocItem
         frmAddChequeDocReceiptDocItem.Show 1
   
         OKClick = frmAddChequeDocReceiptDocItem.OKClick
   
         Unload frmAddChequeDocReceiptDocItem
         Set frmAddChequeDocReceiptDocItem = Nothing
...
Dim No As String
   ...
   If Trim(txtDocumentNo.Text) = "" Then
      Call glbDatabaseMngr.GenerateNumber(RECEIPT_NUMBER, No, glbErrorLog)
