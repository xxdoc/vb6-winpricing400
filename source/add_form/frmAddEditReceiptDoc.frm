...
Begin VB.Form frmAddEditReceiptDoc 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddEditReceiptDoc.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditReceiptDoc.frx":27A2
         Column(2)       =   "frmAddEditReceiptDoc.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditReceiptDoc.frx":290E
         FormatStyle(2)  =   "frmAddEditReceiptDoc.frx":2A6A
         FormatStyle(3)  =   "frmAddEditReceiptDoc.frx":2B1A
         FormatStyle(4)  =   "frmAddEditReceiptDoc.frx":2BCE
         FormatStyle(5)  =   "frmAddEditReceiptDoc.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddEditReceiptDoc.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddEditReceiptDoc.frx":2F36
         Column(2)       =   "frmAddEditReceiptDoc.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddEditReceiptDoc.frx":30A2
         FormatStyle(2)  =   "frmAddEditReceiptDoc.frx":31FE
         FormatStyle(3)  =   "frmAddEditReceiptDoc.frx":32AE
         FormatStyle(4)  =   "frmAddEditReceiptDoc.frx":3362
         FormatStyle(5)  =   "frmAddEditReceiptDoc.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddEditReceiptDoc.frx":34F2
      End
      ...
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditReceiptDoc.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditReceiptDoc.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditReceiptDoc.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditReceiptDoc.frx":4018
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditReceiptDoc"
