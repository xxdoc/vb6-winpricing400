...
Dim X As Double
   ...
   If Flag Then
      X = (BillingDoc.DO_TOTAL_PRICE + BillingDoc.REVENUE_TOTAL_PRICE - BillingDoc.SUM_DISCOUNT_AMOUNT)
      txtLotNo.Text = BillingDoc.DOCUMENT_NO
      txtItemAmount.Text = X
      ...
      txtPaidAmount.Text = Format(X + (BillingDoc.DEBIT_AMOUNT - BillingDoc.CREDIT_AMOUNT) - BillingDoc.PAID_AMOUNT - BillingDoc.CASH_DISCOUNT, "0.00")
   End If
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblBillAmount, MapText("ชำระแล้ว"))
