...
'      lMenuChosen = oMenu.Popup("เพิ่มรายการใหม่ (ทีละรายการ)", "เพิ่มรายการใหม่ (เป็นชุด)")'ยกเลิก ไปก่อนเพราะการตลาดไม่ใช้ 2018-12-25
      ...
      If lMenuChosen = 1 Then
         ...
         frmAddEditSaleOrderItem.HeaderText = MapText("เพิ่มรายการใบ SO")
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      frmAddEditSaleOrderItem.COMMIT_FLAG = m_BillingDoc.COMMIT_FLAG
      Set frmAddEditSaleOrderItem.TempCollection = m_BillingDoc.SaleOrders
      frmAddEditSaleOrderItem.HeaderText = MapText("แก้ไขรายการใบ SO")
      frmAddEditSaleOrderItem.ParentShowMode = ShowMode
