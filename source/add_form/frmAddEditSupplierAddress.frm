...
Begin VB.Form frmAddEditSupplierAddress 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditSupplierAddress.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextBox txtHomeNo 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtVillage 
         Height          =   435
         Left            =   1710
         TabIndex        =   3
         Top             =   1620
      ...
      Begin prjFarmManagement.uctlTextBox txtRoad 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtAmphur 
         Height          =   435
         Left            =   1710
         TabIndex        =   6
         Top             =   2970
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtDistrict 
         Height          =   435
         Left            =   1710
         TabIndex        =   5
         Top             =   2520
      ...
      Begin prjFarmManagement.uctlTextBox txtProvince 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtFax 
         Height          =   435
         Left            =   1710
         TabIndex        =   11
         Top             =   4770
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtPhone 
         Height          =   435
         Left            =   1710
         TabIndex        =   10
         Top             =   4320
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditSupplierAddress.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditSupplierAddress"
...
Dim itemcount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         Dim EnpAddr As CSupplierAddress
         
         Set EnpAddr = TempCollection.Item(ID)
         Set Addr = EnpAddr.Addresses
         
         txtHomeNo.Text = Addr.HOME
         txtSoi.Text = Addr.SOI
         txtMoo.Text = Addr.MOO
         txtVillage.Text = Addr.VILLAGE
         txtRoad.Text = Addr.ROAD
         txtDistrict.Text = Addr.DISTRICT
         txtAmphur.Text = Addr.AMPHUR
         txtProvince.Text = Addr.PROVINCE
         txtZipcode.Text = Addr.ZIPCODE
         txtPhone.Text = Addr.PHONE1
         txtFax.Text = Addr.FAX1
         cboCountry.ListIndex = IDToListIndex(cboCountry, Addr.COUNTRY_ID)
         chkBangkok.Value = FlagToCheck(Addr.BANGKOK_FLAG)
      End If
   End If
...
Dim RealIndex As Long
   ...
   Dim Addr As CAddress
   Dim EnpAddress As CSupplierAddress
   If ShowMode = SHOW_ADD Then
      Set Addr = New CAddress
      Set EnpAddress = New CSupplierAddress
   ...
   Addr.HOME = txtHomeNo.Text
   Addr.SOI = txtSoi.Text
   Addr.MOO = txtMoo.Text
   Addr.VILLAGE = txtVillage.Text
   Addr.ROAD = txtRoad.Text
   Addr.DISTRICT = txtDistrict.Text
   Addr.AMPHUR = txtAmphur.Text
   Addr.PROVINCE = txtProvince.Text
   Addr.ZIPCODE = txtZipcode.Text
   Addr.COUNTRY_ID = cboCountry.ItemData(Minus2Zero(cboCountry.ListIndex))
   Addr.COUNTRY_NAME = cboCountry.Text
   Addr.FAX1 = txtFax.Text
   Addr.PHONE1 = txtPhone.Text
   Addr.BANGKOK_FLAG = Check2Flag(chkBangkok.Value)
