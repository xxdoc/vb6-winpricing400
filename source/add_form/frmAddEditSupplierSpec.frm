...
Begin VB.Form frmAddEditSupplierSpec 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditSupplierSpec.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditSupplierSpec.frx":08CA
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditSupplierSpec"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblPrice, MapText("% ความชื้น"))
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If ShowMode = SHOW_EDIT Then
         ...
         txtPrice.Text = EnpAddr.HUMIDITY
...
Dim RealIndex As Long
   ...
   Dim EnpAddress As CSupplierSpec
   If ShowMode = SHOW_ADD Then
      Set EnpAddress = New CSupplierSpec
      EnpAddress.Flag = "A"
   ...
   EnpAddress.HUMIDITY = Val(txtPrice.Text)
