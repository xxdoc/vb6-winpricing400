...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblSupTransCode, MapText("รหัสทะเบียนรถ"))
   Call InitNormalLabel(lblSupTransDesc, MapText("เลขทะเบียนรถ"))
...
Dim RealIndex As Long
   ...
   Dim D As CSupplierTranSport 'ตรวจสอบใน Collection ก่อนการบันทึกด้วย
   Set D = GetObject("CSupplierTranSport", TempCollection, Trim(txtSupTransCode.Text), False)
   If Not D Is Nothing Then
       glbErrorLog.LocalErrorMsg = MapText("มีข้อมูล") & " " & txtSupTransDesc.Text & " " & MapText("อยู่ในระบบแล้ว")
