...
Begin VB.Form frmAddEditTransferItemWh 
   BackColor       =   &H80000000&
   ...
   EndProperty
   Icon            =   "frmAddEditTransferItemWh.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdLotSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditTransferItemWh.frx":08CA
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddEditTransferItemWh.frx":0BE4
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddEditTransferItemWh"
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblToLocation, MapText("เข้าคลัง"))
   Call InitNormalLabel(Label1, MapText("บาท"))
   Call InitNormalLabel(lblPackaging, MapText("จำนวนหีบห่อ"))
   Call InitNormalLabel(lblToPartType, MapText("ประเภทวัตถุดิบ"))
   Call InitNormalLabel(lblToPartItem, MapText("วัตถุดิบ"))
   Call InitNormalLabel(lblManualPrice, MapText("ราคา/หน่วย"))
   ...
   Call InitCheckBox(chkManualPrice, "กำหนดราคาเอง")
...
Dim LIW As CLotItemWH
  ...
  Call m_InventoryWHDoc.C_LotItemsWH.add(LIW)
 
   frmAddEditTrnGoods.HeaderText = "เลือกหมายเลขล็อต"
   frmAddEditTrnGoods.ShowMode = ShowMode
   frmAddEditTrnGoods.ID = 1
   frmAddEditTrnGoods.DOCUMENT_TYPE = DOCUMENT_TYPE
   Set frmAddEditTrnGoods.TempLotItemsWH = m_InventoryWHDoc.C_LotItemsWH
