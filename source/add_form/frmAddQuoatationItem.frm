...
Begin VB.Form frmAddQuoatationItem 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddQuoatationItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddQuoatationItem.frx":27A2
         Column(2)       =   "frmAddQuoatationItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddQuoatationItem.frx":290E
         FormatStyle(2)  =   "frmAddQuoatationItem.frx":2A6A
         FormatStyle(3)  =   "frmAddQuoatationItem.frx":2B1A
         FormatStyle(4)  =   "frmAddQuoatationItem.frx":2BCE
         FormatStyle(5)  =   "frmAddQuoatationItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddQuoatationItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddQuoatationItem.frx":2F36
         Column(2)       =   "frmAddQuoatationItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddQuoatationItem.frx":30A2
         FormatStyle(2)  =   "frmAddQuoatationItem.frx":31FE
         FormatStyle(3)  =   "frmAddQuoatationItem.frx":32AE
         FormatStyle(4)  =   "frmAddQuoatationItem.frx":3362
         FormatStyle(5)  =   "frmAddQuoatationItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddQuoatationItem.frx":34F2
      End
      ...
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddQuoatationItem.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddQuoatationItem.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddQuoatationItem.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddQuoatationItem.frx":4018
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddQuoatationItem"
...
Private m_Quoatation As CBillingDoc
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      m_Quoatation.BILLING_DOC_ID = -1
      m_Quoatation.COMMIT_FLAG = "Y"
      m_Quoatation.FROM_DATE = -1
      m_Quoatation.TO_DATE = -1
      m_Quoatation.ACCOUNT_ID = AccountID
      m_Quoatation.DOCUMENT_TYPE = 14
      Call glbDaily.QueryBillingDoc(m_Quoatation, m_Rs, ItemCount, IsOK, glbErrorLog)
   End If
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      If (ShowMode = SHOW_EDIT) Or (ShowMode = SHOW_VIEW_ONLY) Then
         m_Quoatation.QueryFlag = 1
         Call QueryData(True)
      ElseIf ShowMode = SHOW_ADD Then
         m_Quoatation.QueryFlag = 0
         Call QueryData(True)
      End If
...
'
'   Sum = 0
'   For Each II In m_Quoatation.ImportExports
'      If II.Flag <> "D" Then
...
Private Sub Form_Load()
   ...
   Set m_Quoatation = New CBillingDoc
   Set m_TempCol1 = New Collection
...
Dim RealIndex As Long
   ...
   Values(4) = FormatNumber(CR.TOTAL_PRICE)
   Exit Sub
