...
Begin VB.Form frmAddReceiptItem 
   ...
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddReceiptChequeDocItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddReceiptChequeDocItem.frx":27A2
         Column(2)       =   "frmAddReceiptChequeDocItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddReceiptChequeDocItem.frx":290E
         FormatStyle(2)  =   "frmAddReceiptChequeDocItem.frx":2A6A
         FormatStyle(3)  =   "frmAddReceiptChequeDocItem.frx":2B1A
         FormatStyle(4)  =   "frmAddReceiptChequeDocItem.frx":2BCE
         FormatStyle(5)  =   "frmAddReceiptChequeDocItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddReceiptChequeDocItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddReceiptChequeDocItem.frx":2F36
         Column(2)       =   "frmAddReceiptChequeDocItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddReceiptChequeDocItem.frx":30A2
         FormatStyle(2)  =   "frmAddReceiptChequeDocItem.frx":31FE
         FormatStyle(3)  =   "frmAddReceiptChequeDocItem.frx":32AE
         FormatStyle(4)  =   "frmAddReceiptChequeDocItem.frx":3362
         FormatStyle(5)  =   "frmAddReceiptChequeDocItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddReceiptChequeDocItem.frx":34F2
      End
      ...
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptChequeDocItem.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptChequeDocItem.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptChequeDocItem.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptChequeDocItem.frx":4018
         ButtonStyle     =   3
      End
