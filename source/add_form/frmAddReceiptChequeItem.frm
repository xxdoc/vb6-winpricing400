...
Begin VB.Form frmAddReceiptChequeItem 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddReceiptChequeItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddReceiptChequeItem.frx":27A2
         Column(2)       =   "frmAddReceiptChequeItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddReceiptChequeItem.frx":290E
         FormatStyle(2)  =   "frmAddReceiptChequeItem.frx":2A6A
         FormatStyle(3)  =   "frmAddReceiptChequeItem.frx":2B1A
         FormatStyle(4)  =   "frmAddReceiptChequeItem.frx":2BCE
         FormatStyle(5)  =   "frmAddReceiptChequeItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddReceiptChequeItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddReceiptChequeItem.frx":2F36
         Column(2)       =   "frmAddReceiptChequeItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddReceiptChequeItem.frx":30A2
         FormatStyle(2)  =   "frmAddReceiptChequeItem.frx":31FE
         FormatStyle(3)  =   "frmAddReceiptChequeItem.frx":32AE
         FormatStyle(4)  =   "frmAddReceiptChequeItem.frx":3362
         FormatStyle(5)  =   "frmAddReceiptChequeItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddReceiptChequeItem.frx":34F2
      End
      ...
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptChequeItem.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptChequeItem.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptChequeItem.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptChequeItem.frx":4018
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddReceiptChequeItem"
...
Dim X As Double
   ...
   While Not Rs.EOF
      ...
      ' Call Bd.PopulateFromRS(104, Rs)'' เปลี่ยนเป็น Call Bd.PopulateFromRS(104, Rs) เพื่อเช็ค bill ที่ตัดโดย cheque ที่ถูกเก็บไว้ในตารางRECEIPT_CHEQUE_DOC : ต้องเช็ค 2 ทาง  ถูกเก็บไว้ในตารางRECEIPT_ITEM เพื่อเปิดbill  ครั้งใหม่จะได้หายไป อันที่ถูกตัด
      
      If Bd.DOCUMENT_NO = "01-00612-13" Then
         Debug.Print (Bd.DOCUMENT_NO)
      End If
        X = Val(Format(Bd.DO_TOTAL_PRICE + Bd.REVENUE_TOTAL_PRICE - Bd.SUM_DISCOUNT_AMOUNT + (Bd.DEBIT_AMOUNT - Bd.CREDIT_AMOUNT) - Bd.PAID_AMOUNT - Bd.CASH_DISCOUNT, "0.00"))
 ...
 If X <> 0 Then       'ติดค้างมากกว่ายอดหนี้                                            'เดี่ยวแก้ไข
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      If Area = 1 Then
         ...
         If ReceiptType = 3 Then  'สร้างจาก Do
            m_BillingDoc.DOCUMENT_TYPE = 1
         ElseIf ReceiptType = 5 Then  'สร้างจาก Invoice
...
Dim L As CBillingDoc
   ...
   If ID > 0 Then
      ...
      frmAddEditReceiptItemAmount.HeaderText = "ชำระเงินลูกค้า"
      Set frmAddEditReceiptItemAmount.BillingDoc = L
      frmAddEditReceiptItemAmount.ShowMode = SHOW_EDIT
      Load frmAddEditReceiptItemAmount
      frmAddEditReceiptItemAmount.Show 1
      
      OKClick = frmAddEditReceiptItemAmount.OKClick
      
      Unload frmAddEditReceiptItemAmount
      Set frmAddEditReceiptItemAmount = Nothing
...
Dim Ri As CReceiptItem
   ...
   For Each D In m_TempCol2
      ...
      If D.Flag = "A" Then
         ...
         If D.PAID_TYPE = 1 Then 'ชำระเต็มวงเงิน
