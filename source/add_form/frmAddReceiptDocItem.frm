...
Begin VB.Form frmAddReceiptDocItem 
   ...
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddReceiptDocItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddReceiptDocItem.frx":27A2
         Column(2)       =   "frmAddReceiptDocItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddReceiptDocItem.frx":290E
         FormatStyle(2)  =   "frmAddReceiptDocItem.frx":2A6A
         FormatStyle(3)  =   "frmAddReceiptDocItem.frx":2B1A
         FormatStyle(4)  =   "frmAddReceiptDocItem.frx":2BCE
         FormatStyle(5)  =   "frmAddReceiptDocItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddReceiptDocItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddReceiptDocItem.frx":2F36
         Column(2)       =   "frmAddReceiptDocItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddReceiptDocItem.frx":30A2
         FormatStyle(2)  =   "frmAddReceiptDocItem.frx":31FE
         FormatStyle(3)  =   "frmAddReceiptDocItem.frx":32AE
         FormatStyle(4)  =   "frmAddReceiptDocItem.frx":3362
         FormatStyle(5)  =   "frmAddReceiptDocItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddReceiptDocItem.frx":34F2
      End
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptDocItem.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptDocItem.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptDocItem.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddReceiptDocItem.frx":4018
         ButtonStyle     =   3
      End
...
Dim X As Double
   ...
   While Not Rs.EOF
      ...
      If BD.DOCUMENT_NO = "10-00095-15" Then
...
'      X = Val(Format(Bd.DO_TOTAL_PRICE + Bd.REVENUE_TOTAL_PRICE - Bd.SUM_DISCOUNT_AMOUNT + (Bd.DEBIT_AMOUNT - Bd.CREDIT_AMOUNT) - Bd.PAID_AMOUNT - Bd.CASH_DISCOUNT, "0.00"))
            X = Val(Format(BD.DO_TOTAL_PRICE + BD.REVENUE_TOTAL_PRICE - BD.SUM_DISCOUNT_AMOUNT + (BD.DEBIT_AMOUNT - BD.CREDIT_AMOUNT) - BD.CASH_DISCOUNT - BD.SUM_PAID_AMOUNT2, "0.00"))
      If X <> 0 Or X > 0 Then       'ติดค้างมากกว่ายอดหนี้                            หรือ โดนตัดไปแล้วในใบเสร็จรับชำระ(กันตัด ไว้ หากตัดที่หลังจะติดลบ )                'เดี่ยวแก้ไข
...
Dim L As CBillingDoc
   ...
   If id > 0 Then
      ...
      frmAddEditReceiptDocAmount.HeaderText = "ชำระเงินลูกค้า"
...
Dim X As Double
   ...
   If CR Is Nothing Then
      Exit Sub
   End If
'   If CR.DOCUMENT_NO = "10-00095-15" Then
'        ''Debug.Print CR.DOCUMENT_NO
'   End If
...
'   X = X + (CR.DEBIT_AMOUNT - CR.CREDIT_AMOUNT) - CR.PAID_AMOUNT - CR.CASH_DISCOUNT - CR.SUM_PAID_AMOUNT2
   X = X + (CR.DEBIT_AMOUNT - CR.CREDIT_AMOUNT) - CR.CASH_DISCOUNT - CR.SUM_PAID_AMOUNT2
'   X = X + (CR.DEBIT_AMOUNT - CR.CREDIT_AMOUNT) - CR.CASH_DISCOUNT - CR.PAID_AMOUNT
