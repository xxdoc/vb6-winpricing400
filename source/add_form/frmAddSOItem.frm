...
Begin VB.Form frmAddSOItem 
   ClientHeight    =   9840
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15690
   Icon            =   "frmAddSOItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddSOItem.frx":27A2
         Column(2)       =   "frmAddSOItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddSOItem.frx":290E
         FormatStyle(2)  =   "frmAddSOItem.frx":2A6A
         FormatStyle(3)  =   "frmAddSOItem.frx":2B1A
         FormatStyle(4)  =   "frmAddSOItem.frx":2BCE
         FormatStyle(5)  =   "frmAddSOItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddSOItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddSOItem.frx":2F36
         Column(2)       =   "frmAddSOItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddSOItem.frx":30A2
         FormatStyle(2)  =   "frmAddSOItem.frx":31FE
         FormatStyle(3)  =   "frmAddSOItem.frx":32AE
         FormatStyle(4)  =   "frmAddSOItem.frx":3362
         FormatStyle(5)  =   "frmAddSOItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddSOItem.frx":34F2
      End
      ...
      Begin Threed.SSCommand cmdClear 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSOItem.frx":36CA
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSOItem.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSOItem.frx":3CFE
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSOItem.frx":4018
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSOItem.frx":4332
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddSOItem"
...
Dim TempColl As Collection
   ...
   If Flag Then
      ...
      m_SO.BILLING_DOC_ID = -1
      m_SO.COMMIT_FLAG = ""
      m_SO.FROM_DATE = uctlFromDate.ShowDate 'DocumentDate
      m_SO.TO_DATE = uctlToDate.ShowDate 'DocumentDate

      m_SO.CUSTOMER_CODE = Trim(txtCustomer.Text)  'CustomerCode
      m_SO.DOCUMENT_NO = Trim(txtDoNo.Text)  'DocumentNo
      m_SO.NOTE = Trim(txtTruckNo.Text) 'TruckNo
      
      m_SO.LOAD_FLAG = ""
      m_SO.SUCCESS_FLAG = ""
      m_SO.DOCUMENT_TYPE_WH = 0
      
      If Area = 1 Or Area = 2 Or Area = 4 Or Area = 5 Or Area = 6 Then
         m_SO.DOCUMENT_TYPE = 19 'ใบ So
      ElseIf Area = 3 Then
         m_SO.DOCUMENT_TYPE = 1
      End If
      
      If Area = 4 Or Area = 5 Or Area = 6 Then
         m_SO.B_SUCCESS_FLAG = "Y" 'ดึงเฉพาะเอกสาร So ที่ขึ้นอาหารเรียบร้อยแล้ว
         Call m_SO.QueryData(114, m_Rs, ItemCount)
         Set TempColl = New Collection
         While Not m_Rs.EOF
            Set m_SO = Nothing
            Set m_SO = New CBillingDoc
            Call m_SO.PopulateFromRS(114, m_Rs)
            If Area = 1 Or Area = 2 Then
            m_SO.DOCUMENT_TYPE = 19 'ใบ So
            ElseIf Area = 3 Then
            m_SO.DOCUMENT_TYPE = 1
            ElseIf Area = 4 Or Area = 5 Or Area = 6 Then
            m_SO.DOCUMENT_TYPE_WH = DOCUMENT_TYPE
            End If
            Call LoadInventoryWhDoc(Nothing, TempColl, , , m_SO.BILLING_DOC_ID, DOCUMENT_TYPE, m_SO.EDIT_PRICE_FLAG)
            m_Rs.MoveNext
        Wend
      Else
          m_SO.B_SUCCESS_FLAG = "N" 'ดึงเฉพาะเอกสาร So ที่ยังไม่ขึ้นอาหาร
         Call m_SO.QueryData(113, m_Rs, ItemCount)
      End If
   ...
   Else
      ...
      GridEX1.Rebind
      If Area = 1 Or Area = 2 Or Area = 4 Or Area = 5 Or Area = 6 Then
         Call MsgBox("ไม่มีข้อมูล SO กรุณาตรวจสอบเงื่อนไขอีกครั้ง", vbOKOnly)
      ElseIf Area = 3 Then
         Call MsgBox("ไม่มีข้อมูล Invoice กรุณาตรวจสอบเงื่อนไขอีกครั้ง", vbOKOnly)
      End If
   End If
...
Dim IsOK As Boolean
   ...
   If Not m_HasModify Then
      ...
      Exit Function
   End If
   If Area = 2 Or Area = 4 Or Area = 5 Or Area = 6 Then
      Call PopulateTempColl(SumLotAmount)
   Else
      Call PopulateTempColl2(SumLotAmount)
   End If
...
Dim TempCol3 As Collection
   ...
   If ID > 0 Then
      Set L = TempCol1(ID)
      L.DOCUMENT_TYPE = DocType
      L.QueryFlag = 1
      L.DOCUMENT_TYPE_WH = DOCUMENT_TYPE
      If Area = 1 Or Area = 2 Then
         If DOCUMENT_TYPE = 2000 Then
         L.PART_TYPE = 10
         ElseIf DOCUMENT_TYPE = 2001 Then
         L.PART_TYPE = 21
         ElseIf DOCUMENT_TYPE = 2004 Then
         L.PART_TYPE_OVER = "(10,21)"
         End If
      End If
      
      
      TempDoc = frmAddEditInventoryDocWh.DOCUMENT_NO
      If Len(TempDoc) > 0 Then
         frmAddEditInventoryDocWh.DOCUMENT_NO = TempDoc & "," & L.DOCUMENT_NO
      Else
         frmAddEditInventoryDocWh.DOCUMENT_NO = L.DOCUMENT_NO
      End If
      
      TempTruck = frmAddEditInventoryDocWh.TRUCK_NO
      NOTE = L.DELIVERY_CUS_ITEM_NAME
      If Len(TempTruck) > 0 Then
         frmAddEditInventoryDocWh.TRUCK_NO = TempTruck & "," & L.TRUCK_NO
      Else
         frmAddEditInventoryDocWh.TRUCK_NO = L.TRUCK_NO
      End If
      
      Call glbDaily.QueryBillingDoc(L, TempRs, iCount, IsOK, glbErrorLog)
      
      If DocType = 1 Then
         For Each Poi2 In L.DoItems
            Set Di = New CDoItem
            Call Di.CopyObjectFromDo(1, Poi2)
            Di.Flag = "A"
            Di.BILLING_DOC_ID = L.BILLING_DOC_ID
      ...
      ElseIf DocType = 19 Then
         For Each Poi In L.SaleOrders
            ...
            If Area = 1 Then 'ถ้าเป็นการเข้าไป update ใบขึ้นอาหารใหม่จาก ใบ SO
            Dim temp_DI As CDoItem
             If DOCUMENT_TYPE = 2004 Then 'กรณีการขายอื่นๆ
                Di.PART_DESC = Di.FEATURE_DESC
                  Set temp_DI = GetObject("CDoItem", TempCol2, Trim(str(Di.PO_ID) & "-" & str(Di.PART_ITEM_ID) & "-" & str(Di.FEATURE_ID)), False)
                   ...
                   Else
                       Call TempCol2.add(Di, Trim(str(Di.PO_ID) & "-" & str(Di.PART_ITEM_ID) & "-" & str(Di.FEATURE_ID)))
                    End If
         ...
         If Area = 1 Then ' ถ้าเป็นการเข้าไป update ใบขึ้นอาหารใหม่จาก ใบ SO ให้ทำการเคลียร์ รายการใบขึ้นอาหารเดิมที่ไม่มีใน So ใบใหม่
            For Each Di In TempCol2
               If (Di.Flag <> "A") And (Di.Flag <> "E") Then
                   If DOCUMENT_TYPE = 2004 Then 'กรณีการขายอื่นๆ
                     Set temp_DI = GetObject("CDoItem", TempCol2, Trim(str(Di.PO_ID) & "-" & str(Di.PART_ITEM_ID) & "-" & str(Di.FEATURE_ID)), False)
                   Else
                     Set temp_DI = GetObject("CDoItem", TempCol2, Trim(str(Di.PO_ID) & "-" & str(Di.PART_ITEM_ID)), False)
      ...
      ElseIf DocType = 2000 Or DocType = 2001 Or DocType = 2004 Then
          If L.EDIT_PRICE_FLAG = "Y" And (Area = 4 Or Area = 5 Or Area = 6) And TempCol2.Count > 0 Then  ' ถ้าเป็นการเข้าไป update ใบขึ้นอาหารใหม่จาก ใบ SO ให้ทำการเคลียร์ รายการใบขึ้นอาหารเดิมที่ไม่มีใน So ใบใหม่
            For Each Poi In L.SaleOrders
                      If DOCUMENT_TYPE = 2004 Then 'กรณีการขายอื่นๆ
                        Set temp_DI = GetObject("CDoItem", TempCol2, Trim(str(Poi.DO_ID) & "-" & str(Poi.PART_ITEM_ID) & "-" & str(Poi.FEATURE_ID)), False)
                      Else
                        Set temp_DI = GetObject("CDoItem", TempCol2, Trim(str(Poi.DO_ID) & "-" & str(Poi.PART_ITEM_ID)), False)
                      End If
                      If Not temp_DI Is Nothing Then
                        temp_DI.Flag = "E"
                        temp_DI.PRICE_PER_PACK = Poi.PRICE_PER_PACK
                      End If
            Next Poi
      ...
      'end Copy
         Set c_LIW = New Collection
        Call LoadPackAmountFromLWH(Nothing, c_LIW, , , L.BILLING_DOC_ID)
         For Each Poi In L.SaleOrders
            Set Di = New CDoItem
            Call Di.CopyObjectFromSo(1, Poi)
            Di.Flag = "A"
            ...
            Di.PO_NO = Poi.DOCUMENT_NO
            Di.BILLING_DOC_ID = Poi.DO_ID
            Di.BILLING_DOC_SO_ID = Poi.DO_ID
            PackAmount = 0
            Set temp_LIW = GetObject("CLotItemWH", c_LIW, Trim(str(Poi.PART_ITEM_ID) & "-" & str(Poi.FEATURE_ID) & "-" & str(Poi.DO_ID)), False)
            If Not temp_LIW Is Nothing Then
                 PackAmount = temp_LIW.PACK_AMOUNT
                  Di.PACK_AMOUNT = temp_LIW.PACK_AMOUNT
                  Di.WEIGHT_PER_PACK = Poi.WEIGHT_PER_PACK
                  If DOCUMENT_TYPE = 2001 Then 'Or DOCUMENT_TYPE = 2004
                     Di.PACK_AMOUNT = temp_LIW.TX_AMOUNT 'ให้ ยอดแพ็คเท่ากับ น้ำหนักด้วย
                     Di.ITEM_AMOUNT = temp_LIW.TX_AMOUNT
                  Else
                     Di.ITEM_AMOUNT = FormatNumber(Poi.WEIGHT_PER_PACK * temp_LIW.PACK_AMOUNT)
                 End If
                  Di.TOTAL_PRICE = FormatNumber(Poi.TOTAL_PRICE) 'FormatNumber(Di.ITEM_AMOUNT * Di.AVG_PRICE)

            Else
                If Di.PART_ITEM_ID > -1 Then 'ถ้าเป็นสินค้าให้เครียร์เป็น 0 แต่ถ้าเป็นค่าขนส่งก็ให้ ดึงมาจาก Sale Order ด้วย
                   Di.PACK_AMOUNT = 0
                  Di.WEIGHT_PER_PACK = 0
                  Di.ITEM_AMOUNT = 0
               End If
            End If
            
            If PackAmount > 0 Or Di.PART_ITEM_ID = -1 Then  'ให้เอาเฉพาะ ตัวที่มีจำนวน Load และค่าขนส่ง เท่านั้น
               If Di.PART_ITEM_ID = -1 Then 'หากเป็น ค่าขนส่ง ให้เก็บไว้ก่อน เพื่อเอาไปไว้ต่อข้างหลัง
                  Call TempCol3.add(Di)
               Else
                 Call TempCol2.add(Di)
               End If
            End If
    ...
    End If
      ...
      For Each Di In TempCol3 'เอาค่าขนส่งมาต่อข้างหลัง
         Call TempCol2.add(Di)
      Next Di
      
      If L.SaleOrders.Count > 0 Then
   ...
   Set TempRs = Nothing
End Sub
Public Sub CopyItemEditPrice(TempCol1 As Collection, TempCol2 As Collection, ID As Long, Optional DocType As Long = -1)
Dim L As CBillingDoc
Dim OKClick As Boolean
Dim iCount As Long
Dim TempRs As ADODB.Recordset
      ...
      'end Copy
        ...
        Call LoadPackAmountFromLWH(Nothing, c_LIW, , , L.BILLING_DOC_ID)
         For Each Poi In L.SaleOrders
            ...
            Di.BILLING_DOC_SO_ID = Poi.DO_ID
            PackAmount = 0
'            Set temp_LIW = GetObject("CLotItemWH", c_LIW, Trim(str(Poi.PART_ITEM_ID) & "-" & str(Poi.DO_ID)), False)
            Set temp_LIW = GetObject("CLotItemWH", c_LIW, Trim(str(Poi.PART_ITEM_ID) & "-" & str(Poi.FEATURE_ID) & "-" & str(Poi.DO_ID)), False)
            If Not temp_LIW Is Nothing Then
                 PackAmount = temp_LIW.PACK_AMOUNT
                  Di.PACK_AMOUNT = temp_LIW.PACK_AMOUNT
...
''          If Area = 5 Then ' ถ้าเป็นการเข้าไป update ใบขึ้นอาหารใหม่จาก ใบ SO ให้ทำการเคลียร์ รายการใบขึ้นอาหารเดิมที่ไม่มีใน So ใบใหม่
''            For Each Di In TempCol2
''               If (Di.Flag <> "A") And (Di.Flag <> "E") Then
''                   If DOCUMENT_TYPE = 2004 Then 'กรณีการขายอื่นๆ
''                     Set temp_DI = GetObject("CDoItem", TempCol2, Trim(str(Di.DO_ID) & "-" & str(Di.PART_ITEM_ID) & "-" & str(Di.FEATURE_ID)), False)
''                   Else
''                     Set temp_DI = GetObject("CDoItem", TempCol2, Trim(str(Di.DO_ID) & "-" & str(Di.PART_ITEM_ID)), False)
''                   End If
''                   If Not temp_DI Is Nothing Then
''                     temp_DI.Flag = "D"
''                   End If
...
Dim TempID As Long
   ...
   ElseIf Area = 3 Then
      Call CopyItem(m_TempCol1, m_TempCol2, TempID, 1)
   ElseIf Area = 4 Or Area = 5 Or Area = 6 Then
      If m_TempCol2 Is Nothing Then
         Set m_TempCol2 = New Collection
      End If
            
      Call CopyItem(m_TempCol1, m_TempCol2, TempID, DOCUMENT_TYPE)
   End If
...
Dim LIW As CLotItemWH
   ...
   For Each D In m_TempCol2
      ...
      ElseIf (D.Flag = "E") Then
          For Each Ri In TempCollection
            If Ri.PO_ID = D.PO_ID And Ri.PART_ITEM_ID = D.PART_ITEM_ID And Ri.FEATURE_ID = D.FEATURE_ID Then
               Ri.Flag = D.Flag
               Ri.PRICE_PER_PACK = D.PRICE_PER_PACK
               Ri.AVG_PRICE = MyDiff(D.PACK_AMOUNT * D.PRICE_PER_PACK, D.ITEM_AMOUNT)  'D.PRICE_PER_PACK * D.PACK_AMOUNT
               Ri.TOTAL_PRICE = Ri.AVG_PRICE * D.ITEM_AMOUNT - D.DISCOUNT_AMOUNT
            End If
          Next Ri
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblFromDate, MapText("จากวันที่"))
    If Area = 1 Or Area = 2 Or Area = 4 Then
      Call InitNormalLabel(lblDoNo, MapText("SO No."))
    ElseIf Area = 3 Then
      Call InitNormalLabel(lblDoNo, MapText("INVOICE No."))
   End If
