...
Begin VB.Form frmAddSubLotItem 
   ClientHeight    =   8490
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   11880
   Icon            =   "frmAddSubLotItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddSubLotItem.frx":27A2
         Column(2)       =   "frmAddSubLotItem.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddSubLotItem.frx":290E
         FormatStyle(2)  =   "frmAddSubLotItem.frx":2A6A
         FormatStyle(3)  =   "frmAddSubLotItem.frx":2B1A
         FormatStyle(4)  =   "frmAddSubLotItem.frx":2BCE
         FormatStyle(5)  =   "frmAddSubLotItem.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmAddSubLotItem.frx":2D5E
      End
      ...
      Begin GridEX20.GridEX GridEX2 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmAddSubLotItem.frx":2F36
         Column(2)       =   "frmAddSubLotItem.frx":2FFE
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmAddSubLotItem.frx":30A2
         FormatStyle(2)  =   "frmAddSubLotItem.frx":31FE
         FormatStyle(3)  =   "frmAddSubLotItem.frx":32AE
         FormatStyle(4)  =   "frmAddSubLotItem.frx":3362
         FormatStyle(5)  =   "frmAddSubLotItem.frx":343A
         ImageCount      =   0
         PrinterProperties=   "frmAddSubLotItem.frx":34F2
      End
      ...
      Begin Threed.SSCommand cmdSelectAll 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSubLotItem.frx":36CA
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSelect 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSubLotItem.frx":39E4
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSubLotItem.frx":3CFE
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmAddSubLotItem.frx":4018
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmAddSubLotItem"
...
Dim BD As CLotItem
   ...
   While Not Rs.EOF
      Set BD = New CLotItem
      Call BD.PopulateFromRS(9, Rs)
      
      If Not IsIn(m_TempCol2, BD.LOT_ITEM_ID) Then
         Call TempCol.add(BD)
      End If
...
Dim OKClick As Boolean
   ...
   If id > 0 Then
      ...
      frmAddEditSubLot.ShowMode = SHOW_EDIT
      Set frmAddEditSubLot.SubLot = L
      Load frmAddEditSubLot
      frmAddEditSubLot.Show 1
      
      OKClick = frmAddEditSubLot.OKClick
      
      Unload frmAddEditSubLot
      Set frmAddEditSubLot = Nothing
...
Dim Sum As Double
   ...
   For Each D In m_TempCol2
      Set Ri = New CSubLotItem

      If (D.Flag = "A") And (D.IncludeFlag) Then
         Ri.Flag = "A"
         Ri.FROM_LOT_ID = D.LOT_ITEM_ID
         Ri.DOCUMENT_DATE = D.DOCUMENT_DATE
         Ri.DOCUMENT_NO = D.DOCUMENT_NO
         Ri.SUBLOT_AMT = D.USED_AMOUNT
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      If (ShowMode = SHOW_EDIT) Or (ShowMode = SHOW_VIEW_ONLY) Then
         m_LotItem.QueryFlag = 1
         Call QueryData(True)
      ElseIf ShowMode = SHOW_ADD Then
         m_LotItem.QueryFlag = 0
         Call QueryData(True)
      End If
...
Dim Col As JSColumn
   ...
   Col.Caption = MapText("จำนวนที่เหลือ")
End Sub
...
Dim Col As JSColumn
   ...
   Col.Width = 1410
   Col.TextAlignment = jgexAlignRight
   Col.Caption = MapText("จำนวนที่เลือก")
End Sub
...
'
'   Sum = 0
'   For Each II In m_LotItem.ImportExports
'      If II.Flag <> "D" Then
...
Dim RealIndex As Long
   ...
   Values(5) = FormatNumber(CR.LEFT_AMOUNT)
   Exit Sub
...
Dim RealIndex As Long
   ...
   Values(3) = DateToStringExtEx2(CR.DOCUMENT_DATE)
   Values(4) = CR.DOCUMENT_NO
   Values(5) = FormatNumber(CR.USED_AMOUNT)
   Exit Sub
