...
'          frmAddEditChequeDoc.HeaderText = MapText("เพิ่มข้อมูลใบตรวจสอบการรับ / คืน เช็ค" & TempStr)
...
'         Set frmAddEditChequeDoc = Nothing
   ...
   frmAddEditReceiptChequeDoc.HeaderText = MapText("เพิ่มข้อมูล" & ChequeDocType2Text(Area))
...
Dim TempStr As String
   ...
   frmAddEditReceiptChequeDoc.HeaderText = MapText("แก้ไขข้อมูล" & ChequeDocType2Text(Area))
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblChequeDocNo, MapText("เลขที่เช็ค"))
...
'        lMenuChosen = oMenu.Popup("เช็คผ่าน", "-", "เช็คไม่ผ่าน")
