...
Begin VB.Form frmChequeDoc 
   BackColor       =   &H80000000&
   ClientHeight    =   8520
   ClientLeft      =   120
   ClientTop       =   405
   ClientWidth     =   11910
   Icon            =   "frmChequeDoc.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   ScaleHeight     =   8520
   ScaleWidth      =   11910
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmChequeDoc.frx":27A2
         Column(2)       =   "frmChequeDoc.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmChequeDoc.frx":290E
         FormatStyle(2)  =   "frmChequeDoc.frx":2A6A
         FormatStyle(3)  =   "frmChequeDoc.frx":2B1A
         FormatStyle(4)  =   "frmChequeDoc.frx":2BCE
         FormatStyle(5)  =   "frmChequeDoc.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmChequeDoc.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmChequeDoc.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmChequeDoc.frx":3250
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmChequeDoc.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmChequeDoc.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmChequeDoc"
...
Dim Programowner As String
   ...
   frmAddEditCashDoc.HeaderText = MapText("เพิ่มข้อมูล" & CashDocType2Text(Area))
...
Dim TempStr As String
   ...
   frmAddEditCashDoc.DocumentType = Area
   frmAddEditCashDoc.HeaderText = MapText("แก้ไขข้อมูล" & CashDocType2Text(Area))
...
Private Sub InitFormLayout()
   ...
   Call InitNormalLabel(lblChequeNoEx, MapText("เลขที่เช็ค"))
