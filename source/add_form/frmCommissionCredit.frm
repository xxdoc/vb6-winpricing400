...
Dim OKClick As Boolean
   If Not VerifyAccessRight("COMMISSION_CREDIT_ADD") Then
      ...
      Exit Sub
   End If
   frmAddEditCommissionCredit.HeaderText = MapText("เพิ่มข้อมูลการปรับเครดิตลูกค้า")
...
Dim OKClick As Boolean
   ...
   frmAddEditCommissionCredit.HeaderText = MapText("แก้ไขข้อมูลการปรับเครดิตลูกค้า")
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 2000
   Col.Caption = MapText("ปรับเครดิตเป็น (วัน)")
