...
Dim OKClick As Boolean
   If Not VerifyAccessRight("PRODUCT_ESTIMATE_ADD") Then
      ...
      Exit Sub
   End If
   frmAddEditCostProduction.HeaderText = MapText("เพิ่มข้อมูลปันค่าใช้จ่ายผลิต")
...
Dim OKClick As Boolean
   ...
   frmAddEditCostProduction.HeaderText = MapText("แก้ไขข้อมูลปันค่าใช้จ่ายผลิต")
...
Private Sub InitFormLayout()
   ...
   Me.Caption = "ปันต้นทุนค่าใช้จ่ายผลิต"
   pnlHeader.Caption = "ปันต้นทุนค่าใช้จ่ายผลิต"
