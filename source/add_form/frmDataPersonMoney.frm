...
Begin VB.Form frmDataPersonMoney 
   BackColor       =   &H80000000&
   ...
   ClientTop       =   330
   ClientWidth     =   11910
   Icon            =   "frmDataPersonMoney.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmDataPersonMoney.frx":27A2
         Column(2)       =   "frmDataPersonMoney.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmDataPersonMoney.frx":290E
         FormatStyle(2)  =   "frmDataPersonMoney.frx":2A6A
         FormatStyle(3)  =   "frmDataPersonMoney.frx":2B1A
         FormatStyle(4)  =   "frmDataPersonMoney.frx":2BCE
         FormatStyle(5)  =   "frmDataPersonMoney.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmDataPersonMoney.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmDataPersonMoney.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmDataPersonMoney.frx":3250
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmDataPersonMoney"
...
Private Sub cmdOK_Click()
   ...
   PersonName = GridEX1.Value(3) & " " & GridEX1.Value(4) & " " & GridEX1.Value(5)
