...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_Employee.EMP_RESIGN_FLAG = Check2FlagConvert2(chkEmp_Resign_Flag.Value)
...
Dim RealIndex As Long
   ...
   Values(5) = m_TempEmployee.POSITION_NAME
    ...
    Set Temp_LTK = GetObject("CLoginTracking", m_LoginTracking, Trim(m_TempEmployee.CREATE_BY), False)
   ...
   Set Temp_LTK = GetObject("CLoginTracking", m_LoginTracking, Trim(m_TempEmployee.MODIFY_BY), False)
   If Not Temp_LTK Is Nothing Then
