...
Begin VB.Form frmExportPostItem 
   BackColor       =   &H80000000&
   ...
   ClientTop       =   330
   ClientWidth     =   10605
   Icon            =   "frmExportPostItem.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frmExportPostItem.frx":27A2
               Key             =   ""
            EndProperty
         EndProperty
      End
      ...
      Begin Threed.SSCommand cmdStart 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmExportPostItem.frx":307C
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmExportPostItem.frx":3396
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmExportPostItem"
...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = "EXPORT ข้อมูล เช็ค"
...
Dim LocationSave As String
   ...
   Set Si = New CCashDocPost
   Call Si.SetFieldValue("CASH_DOC_POST_ID", -1)
   Si.FROM_DATE = uctlFromDate.ShowDate
   Si.TO_DATE = uctlToDate.ShowDate
   Call Si.QueryData(2, m_Rs, iCount)
   ...
   LocationSave = LocationSave & "_PostItem(Waitting).txt"
...
XXX:
   ...
   If Not m_Rs.EOF Then
      Call Si.PopulateFromRS(2, m_Rs)
      
      Call Si.GenerateCpHeader(FileID)
      OldID = Si.CASH_DOC_ID
   End If
   ...
   While Not m_Rs.EOF
      ...
      Call Si.PopulateFromRS(2, m_Rs)
      If OldID <> Si.CASH_DOC_ID Then
         Call Si.GenerateCpHeader(FileID)
         OldID = Si.CASH_DOC_ID
      End If
      
      'Generate detail here
      Call Si.GenerateCpTailer(FileID)
      m_Rs.MoveNext
      I = I + 1
   Wend
   Close #FileID
