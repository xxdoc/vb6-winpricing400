...
Begin VB.Form frmGoldDailyPrice 
   BackColor       =   &H80000000&
   ...
   ClientTop       =   330
   ClientWidth     =   11910
   Icon            =   "frmGoldDailyPrice.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmGoldDailyPrice.frx":27A2
         Column(2)       =   "frmGoldDailyPrice.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmGoldDailyPrice.frx":290E
         FormatStyle(2)  =   "frmGoldDailyPrice.frx":2A6A
         FormatStyle(3)  =   "frmGoldDailyPrice.frx":2B1A
         FormatStyle(4)  =   "frmGoldDailyPrice.frx":2BCE
         FormatStyle(5)  =   "frmGoldDailyPrice.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmGoldDailyPrice.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldDailyPrice.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldDailyPrice.frx":3250
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldDailyPrice.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldDailyPrice.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmGoldDailyPrice"
...
Dim OKClick As Boolean
   ...
   frmAddEditDailyPrice.HeaderText = MapText("เพิ่มข้อมูลราคาทองประจำวัน")
   frmAddEditDailyPrice.ShowMode = SHOW_ADD
   Load frmAddEditDailyPrice
   frmAddEditDailyPrice.Show 1
   
   OKClick = frmAddEditDailyPrice.OKClick
   
   Unload frmAddEditDailyPrice
   Set frmAddEditDailyPrice = Nothing
...
Dim OKClick As Boolean
   ...
   frmAddEditDailyPrice.ID = ID
   frmAddEditDailyPrice.HeaderText = MapText("เแก้ไขข้อมูลราคาทองประจำวัน")
   frmAddEditDailyPrice.ShowMode = SHOW_EDIT
   Load frmAddEditDailyPrice
   frmAddEditDailyPrice.Show 1
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call InitGoldDailyPriceOrderBy(cboOrderBy)
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 2115
   Col.Caption = MapText("ราคา ณ วันที่")
      
   Set Col = GridEX1.Columns.add '3
   Col.Width = 2055
   Col.Caption = MapText("ราคาซื้อ")
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("ราคาทองประจำวัน")
   pnlHeader.Caption = Me.Caption
   
   Call InitGrid
   
   Call InitNormalLabel(lblDocumentDate, MapText("ราคา ณ วันที่"))
