...
Begin VB.Form frmGoldSellBuy 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmGoldSellBuy.frx":27A2
         Column(2)       =   "frmGoldSellBuy.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmGoldSellBuy.frx":290E
         FormatStyle(2)  =   "frmGoldSellBuy.frx":2A6A
         FormatStyle(3)  =   "frmGoldSellBuy.frx":2B1A
         FormatStyle(4)  =   "frmGoldSellBuy.frx":2BCE
         FormatStyle(5)  =   "frmGoldSellBuy.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmGoldSellBuy.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldSellBuy.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldSellBuy.frx":3250
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldSellBuy.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldSellBuy.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmGoldSellBuy"
...
Dim OKClick As Boolean
   ...
   frmAddEditGoldBuySell.HeaderText = MapText("เพิ่มข้อมูลบิลซื้อขายทอง")
   frmAddEditGoldBuySell.ShowMode = SHOW_ADD
   Load frmAddEditGoldBuySell
   frmAddEditGoldBuySell.Show 1
   
   OKClick = frmAddEditGoldBuySell.OKClick
   
   Unload frmAddEditGoldBuySell
   Set frmAddEditGoldBuySell = Nothing
...
Dim OKClick As Boolean
   ...
   frmAddEditGoldBuySell.id = id
   frmAddEditGoldBuySell.HeaderText = MapText("แก้ไขข้อมูลบิลซื้อขายทอง")
   frmAddEditGoldBuySell.ShowMode = SHOW_EDIT
   Load frmAddEditGoldBuySell
   frmAddEditGoldBuySell.Show 1
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call InitGoldSellBuyOrderBy(cboOrderBy)
...
IsOK = True 'Delete this when done
   End If
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 2115
   Col.Caption = MapText("วันที่บิล")
      
   Set Col = GridEX1.Columns.add '3
   Col.Width = 2055
   Col.Caption = MapText("เลขที่บิล")
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("บิลซื้อขายทอง")
   pnlHeader.Caption = MapText("บิลซื้อขายทอง")
   
   Call InitGrid
   
   Call InitNormalLabel(lblDocumentDate, MapText("วันที่บิล"))
   Call InitNormalLabel(lblDocumentNo, MapText("เลขที่เบิล"))
