...
Begin VB.Form frmGoldWage 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmGoldWage.frx":27A2
         Column(2)       =   "frmGoldWage.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmGoldWage.frx":290E
         FormatStyle(2)  =   "frmGoldWage.frx":2A6A
         FormatStyle(3)  =   "frmGoldWage.frx":2B1A
         FormatStyle(4)  =   "frmGoldWage.frx":2BCE
         FormatStyle(5)  =   "frmGoldWage.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmGoldWage.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldWage.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldWage.frx":3250
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldWage.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmGoldWage.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmGoldWage"
...
Dim OKClick As Boolean
   ...
   frmAddEditGoldWage.HeaderText = MapText("เพิ่มข้อมูลค่าแรงช่างทอง")
   frmAddEditGoldWage.ShowMode = SHOW_ADD
   Load frmAddEditGoldWage
   frmAddEditGoldWage.Show 1
   
   OKClick = frmAddEditGoldWage.OKClick
   
   Unload frmAddEditGoldWage
   Set frmAddEditGoldWage = Nothing
...
Dim OKClick As Boolean
   ...
   frmAddEditGoldWage.id = id
   frmAddEditGoldWage.HeaderText = MapText("แก้ไขข้อมูลค่าแรงช่างทอง")
   frmAddEditGoldWage.ShowMode = SHOW_EDIT
   Load frmAddEditGoldWage
   frmAddEditGoldWage.Show 1
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call InitGoldWeightOrderBy(cboOrderBy)
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Caption = MapText("ค่าแรงเงินสด")
   
   Set Col = GridEX1.Columns.add '5
   Col.Width = 1995
   Col.TextAlignment = jgexAlignRight
   Col.Caption = "ค่าแรงเงินเชื่อ"
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("ข้อมูลค่าแรงช่างทอง")
   pnlHeader.Caption = MapText("ข้อมูลค่าแรงช่างทอง")
   
   Call InitGrid
   
   Call InitNormalLabel(lblPartNo, MapText("รหัสสินค้า (ทอง)"))
