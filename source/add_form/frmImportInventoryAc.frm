...
Begin VB.Form frmImportInventoryAc 
   BackColor       =   &H80000000&
   ...
   ClientTop       =   330
   ClientWidth     =   13560
   Icon            =   "frmImportInventoryAc.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSCommand cmdFileName 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmImportInventoryAc.frx":27A2
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdStart 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmImportInventoryAc.frx":2ABC
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmImportInventoryAc.frx":2DD6
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmImportInventoryAc"
