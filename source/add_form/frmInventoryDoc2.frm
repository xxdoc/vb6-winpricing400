...
Dim OKClick As Boolean
   If Not VerifyAccessRight("INVENTORY_EXPORT_ADD") Then
      ...
      Exit Sub
   End If
   frmAddEditInventoryDoc2.HeaderText = MapText("เพิ่มข้อมูลการเบิกจ่าย")
...
Dim OKClick As Boolean
   ...
   frmAddEditInventoryDoc2.HeaderText = MapText("แก้ไขข้อมูลการเบิกจ่าย")
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_InventoryDoc.DOCUMENT_TYPE = 2 'ใบเบิก
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 2115
   Col.Caption = MapText("หมายเลขใบเบิก")
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("เบิกจ่ายวัตถุดิบ")
   pnlHeader.Caption = MapText("เบิกจ่ายวัตถุดิบ")
   
   Call InitGrid
   
   Call InitNormalLabel(lblDocumentDate, MapText("วันที่เอกสาร"))
   Call InitNormalLabel(lblPartNo, MapText("หมายเลขวัตถุดิบ"))
   Call InitNormalLabel(lblDocumentNo, MapText("เลขที่ใบเบิก"))
...
Dim OKClick As Boolean
   ...
   If lMenuChosen = 1 Then
      ...
      Call glbDaily.CopyInventoryDoc(BD, IsOK, True, 1, glbErrorLog)
      Call QueryData(True)
      Set BD = Nothing
   End If
