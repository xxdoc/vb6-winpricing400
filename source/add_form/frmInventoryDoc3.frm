...
Dim OKClick As Boolean
  ...
  If DocPartType = 1 Then
     frmAddEditInventoryDoc3.HeaderText = MapText("เพิ่มข้อมูลการโอนสินค้าระหว่างคลัง")
     frmAddEditInventoryDoc3.DocPartType = DocPartType
  Else
     frmAddEditInventoryDoc3.HeaderText = MapText("เพิ่มข้อมูลการโอนวัตถุดิบ")
  End If
...
Dim OKClick As Boolean
   ...
   frmAddEditInventoryDoc3.id = id
     If DocPartType = 1 Then
     frmAddEditInventoryDoc3.HeaderText = MapText("แก้ไขข้อมูลการโอนสินค้าระหว่างคลัง")
     frmAddEditInventoryDoc3.DocPartType = DocPartType
  Else
     frmAddEditInventoryDoc3.HeaderText = MapText("แก้ไขข้อมูลการโอนวัตถุดิบ")
  End If
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_InventoryDoc.DOCUMENT_TYPE = DocumentType 'ใบโอน
'      If DocPartType = 1 Then
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("โอนย้ายวัตถุดิบ")
   pnlHeader.Caption = MapText("โอนย้ายวัตถุดิบ")
