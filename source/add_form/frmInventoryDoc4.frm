...
Begin VB.Form frmInventoryDoc4 
   BackColor       =   &H80000000&
   ClientHeight    =   8520
   ClientLeft      =   120
   ClientTop       =   405
   ClientWidth     =   11910
   Icon            =   "frmInventoryDoc4.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8520
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmInventoryDoc4.frx":27A2
         Column(2)       =   "frmInventoryDoc4.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmInventoryDoc4.frx":290E
         FormatStyle(2)  =   "frmInventoryDoc4.frx":2A6A
         FormatStyle(3)  =   "frmInventoryDoc4.frx":2B1A
         FormatStyle(4)  =   "frmInventoryDoc4.frx":2BCE
         FormatStyle(5)  =   "frmInventoryDoc4.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmInventoryDoc4.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryDoc4.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryDoc4.frx":3250
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryDoc4.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryDoc4.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmInventoryDoc4"
...
Dim OKClick As Boolean
   If Not VerifyAccessRight("INVENTORY_ADJUST_ADD") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
   frmAddEditInventoryDoc4.DocumentType = DocumentType
   frmAddEditInventoryDoc4.HeaderText = MapText("เพิ่มข้อมูลการปรับยอดวัตถุดิบ")
   frmAddEditInventoryDoc4.ShowMode = SHOW_ADD
   Load frmAddEditInventoryDoc4
   frmAddEditInventoryDoc4.Show 1
   
   OKClick = frmAddEditInventoryDoc4.OKClick
   
   Unload frmAddEditInventoryDoc4
   Set frmAddEditInventoryDoc4 = Nothing
...
Dim id As Long
   If Not VerifyAccessRight("INVENTORY_ADJUST_DELETE") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
...
Dim OKClick As Boolean
   ...
   frmAddEditInventoryDoc4.DocumentType = DocumentType
   frmAddEditInventoryDoc4.id = id
   frmAddEditInventoryDoc4.HeaderText = MapText("แก้ไขข้อมูลการปรับยอดวัตถุดิบ")
   frmAddEditInventoryDoc4.ShowMode = SHOW_EDIT
   Load frmAddEditInventoryDoc4
   frmAddEditInventoryDoc4.Show 1
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 2115
   Col.Caption = MapText("หมายเลขใบปรับยอด")
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("ปรับยอดวัตถุดิบ")
   pnlHeader.Caption = MapText("ปรับยอดวัตถุดิบ")
   
   Call InitGrid
   
   Call InitNormalLabel(lblDocumentDate, MapText("วันที่เอกสาร"))
   Call InitNormalLabel(lblPartNo, MapText("หมายเลขวัตถุดิบ"))
   Call InitNormalLabel(lblDocumentNo, MapText("เลขที่ใบปรับยอด"))
