...
Dim OKClick As Boolean
   ...
   If DocumentType = 15 Then
      frmAddEditInventoryDoc5.HeaderText = MapText("เพิ่มข้อมูลการปรับยอดสินค้า BAG")
   Else
      frmAddEditInventoryDoc5.HeaderText = MapText("เพิ่มข้อมูลการปรับยอดสินค้า BULK")
   End If
...
Dim OKClick As Boolean
   ...
   frmAddEditInventoryDoc5.DocumentType = DocumentType
   If DocumentType = 15 Then
      frmAddEditInventoryDoc5.HeaderText = MapText("แก้ไขข้อมูลการปรับยอดสินค้า BAG")
   Else
      frmAddEditInventoryDoc5.HeaderText = MapText("แก้ไขข้อมูลการปรับยอดสินค้า BULK")
   End If
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      m_InventoryWHDoc.PALLET_NO = 999 'เลือกเฉพาะที่เป็นการปรับยอด
