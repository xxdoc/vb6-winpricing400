...
Begin VB.Form frmInventoryWhDoc3 
   BackColor       =   &H80000000&
   ClientHeight    =   8520
   ClientLeft      =   120
   ClientTop       =   405
   ClientWidth     =   11910
   Icon            =   "frmInventoryWhDoc3.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8520
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmInventoryWhDoc3.frx":27A2
         Column(2)       =   "frmInventoryWhDoc3.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmInventoryWhDoc3.frx":290E
         FormatStyle(2)  =   "frmInventoryWhDoc3.frx":2A6A
         FormatStyle(3)  =   "frmInventoryWhDoc3.frx":2B1A
         FormatStyle(4)  =   "frmInventoryWhDoc3.frx":2BCE
         FormatStyle(5)  =   "frmInventoryWhDoc3.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmInventoryWhDoc3.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryWhDoc3.frx":2F36
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryWhDoc3.frx":3250
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryWhDoc3.frx":356A
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmInventoryWhDoc3.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmInventoryWhDoc3"
...
Dim OKClick As Boolean
   If Not VerifyAccessRight("INVENTORY-WH_TRANSFER_ADD") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
   frmAddEditInventoryWhDoc3.DocumentType = DocumentType
   frmAddEditInventoryWhDoc3.HeaderText = MapText("เพิ่มข้อมูลการ" & HeaderText)
   frmAddEditInventoryWhDoc3.ShowMode = SHOW_ADD
   Load frmAddEditInventoryWhDoc3
   frmAddEditInventoryWhDoc3.Show 1
   
   OKClick = frmAddEditInventoryWhDoc3.OKClick
   
   Unload frmAddEditInventoryWhDoc3
   Set frmAddEditInventoryWhDoc3 = Nothing
...
Dim ID As Long
   If Not VerifyAccessRight("INVENTORY-WH_TRANSFER_DELETE") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
...
Dim ID As Long
Dim OKClick As Boolean
   If Not VerifyAccessRight("INVENTORY-WH_TRANSFER_EDIT") Then
      Call EnableForm(Me, True)
      Exit Sub
   End If
   If Not VerifyGrid(GridEX1.Value(1)) Then
   ...
   frmAddEditInventoryWhDoc3.DocumentType = DocumentType
   frmAddEditInventoryWhDoc3.ID = ID
   frmAddEditInventoryWhDoc3.HeaderText = MapText("แก้ไขข้อมูลการโอนวัตถุดิบ")
   frmAddEditInventoryWhDoc3.ShowMode = SHOW_EDIT
   Load frmAddEditInventoryWhDoc3
   frmAddEditInventoryWhDoc3.Show 1
...
'      m_InventoryWhDoc.PART_NO = PatchWildCard(txtPartNo.Text)
      m_InventoryWHDoc.DOCUMENT_DATE = uctlDocumentDate.ShowDate
      m_InventoryWHDoc.DOCUMENT_TYPE = DocumentType 'ใบโอน
...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = MapText(HeaderText)
   
   Call InitGrid
   
   Call InitNormalLabel(lblDocumentDate, MapText("วันที่เอกสาร"))
   Call InitNormalLabel(lblPartNo, MapText("หมายเลขสินค้า"))
