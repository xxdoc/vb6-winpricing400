...
Begin VB.Form frmLayoutSearch 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmLayoutSearch.frx":27A2
         Column(2)       =   "frmLayoutSearch.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmLayoutSearch.frx":290E
         FormatStyle(2)  =   "frmLayoutSearch.frx":2A6A
         FormatStyle(3)  =   "frmLayoutSearch.frx":2B1A
         FormatStyle(4)  =   "frmLayoutSearch.frx":2BCE
         FormatStyle(5)  =   "frmLayoutSearch.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmLayoutSearch.frx":2D5E
      End
      Begin Threed.SSCommand cmdDelete 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmLayoutSearch.frx":2F36
         ButtonStyle     =   3
      End
      Begin Threed.SSCommand cmdAdd 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmLayoutSearch.frx":3250
         ButtonStyle     =   3
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmLayoutSearch.frx":356A
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmLayoutSearch"
...
Private m_TempInventoryDoc As CLotItem
...
Private Function CountRecord(Rs As ADODB.Recordset) As Long
Dim I As Long
...
Dim Temp As Long
   ...
   If Flag Then
      ...
      Call m_LotItem.QueryData(8, m_Rs, ItemCount)
      ItemCount = CountRecord(m_Rs)
      IsOK = True
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 5580
   Col.Caption = MapText("เลย์เอาต์")
      
   Set Col = GridEX1.Columns.add '3
   Col.Width = 2055
   Col.Caption = MapText("จำนวนที่มีอยู่")
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("เลือกข้อมูลเลย์เอาต์")
   pnlHeader.Caption = MapText("เลือกข้อมูลเลย์เอาต์")
...
Private Sub Form_Load()
   ...
   Set m_TempInventoryDoc = New CLotItem
...
Dim Lo As CLayout
   ...
   Call m_TempInventoryDoc.PopulateFromRS(8, m_Rs)
   
   Set Lo = m_Layouts(Trim(str(m_TempInventoryDoc.LAYOUT_ID)))
   Values(1) = m_TempInventoryDoc.LAYOUT_ID
   Values(2) = Lo.LAY_OUT_NAME
   Values(3) = FormatNumber(m_TempInventoryDoc.LEFT_AMOUNT)
   Exit Sub
