...
Private Sub InitFormLayout()
   ...
   SSFrame2.Caption = "ล็อคเอกสาร STOCK และ การผลิต (ข้อมูลที่ไม่อยู่ในช่วงเวลาที่กำหนดไม่สามารถเปลี่ยนแปลงเอกสารได้แล้ว)"
   SSFrame3.Caption = "ล็อคเอกสาร ใบสั่งซื้อ INVOICE ใบเสร็จขายสด ใบรับคืนสินค้า (ข้อมูลที่ไม่อยู่ในช่วงเวลาที่กำหนดไม่สามารถเปลี่ยนแปลงเอกสารได้แล้ว)"
   SSFrame4.Caption = "ล็อคเอกสาร บัญชีอื่นๆ (ข้อมูลที่ไม่อยู่ในช่วงเวลาที่กำหนดไม่สามารถเปลี่ยนแปลงเอกสารได้แล้ว)"
