...
Dim OKClick As Boolean
   ...
   If DocumentType = COMMISSION_BUDGET_CHART Then
      ...
      frmCommissionBudgetChart.HeaderText = MapText("เพิ่มข้อมูลแผนภูมิ")
   ...
   ElseIf DocumentType = COMMISSION_CONDITION Then
      ...
      frmAddEditMasterValid.HeaderText = MapText("เพิ่มข้อมูลเงื่อนไข COMMISSION")
...
Dim OKClick As Boolean
   ...
   If DocumentType = COMMISSION_BUDGET_CHART Then
      ...
      frmCommissionBudgetChart.DocumentType = DocumentType
      frmCommissionBudgetChart.HeaderText = MapText("แก้ไขข้อมูลแผนภูมิ")        '& Comissiontype2Text(DocumentType)
   ...
   ElseIf DocumentType = COMMISSION_CONDITION Then
      ...
      frmAddEditMasterValid.DocumentType = DocumentType
      frmAddEditMasterValid.HeaderText = MapText("แก้ไขข้อมูลเงื่อนไข COMMISSION")
