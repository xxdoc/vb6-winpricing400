...
Dim oMenu As cPopupMenu
   ...
   frmAddEditPayment.HeaderText = MapText("เพิ่มข้อมูลใบนำฝากธนาคาร")
...
Dim OKClick As Boolean
   ...
   frmAddEditPayment.HeaderText = MapText("แก้ไขข้อมูลการนำฝากธนาคาร")
...
Private Sub InitFormLayout()
   ...
   If Direction = "O" Then
      Me.Caption = MapText("เงินนำฝากธนาคาร")
      pnlHeader.Caption = MapText("เงินนำฝากธนาคาร")
   ElseIf Direction = "I" Then
      Me.Caption = MapText("เงินถอนจากธนาคาร")
      pnlHeader.Caption = MapText("เงินถอนจากธนาคาร")
   End If
