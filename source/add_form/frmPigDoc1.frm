...
Begin VB.Form frmPigDoc1 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmPigDoc1.frx":27A2
         Column(2)       =   "frmPigDoc1.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmPigDoc1.frx":290E
         FormatStyle(2)  =   "frmPigDoc1.frx":2A6A
         FormatStyle(3)  =   "frmPigDoc1.frx":2B1A
         FormatStyle(4)  =   "frmPigDoc1.frx":2BCE
         FormatStyle(5)  =   "frmPigDoc1.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmPigDoc1.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmPigDoc1.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmPigDoc1"
...
'   End If
   ...
   frmAddEditPigDoc1.HeaderText = MapText("เพิ่มข้อมูลสุกรคลอด")
   frmAddEditPigDoc1.ShowMode = SHOW_ADD
   Load frmAddEditPigDoc1
   frmAddEditPigDoc1.Show 1
   
   OKClick = frmAddEditPigDoc1.OKClick
   
   Unload frmAddEditPigDoc1
   Set frmAddEditPigDoc1 = Nothing
...
'   End If
   ...
   frmAddEditPigDoc1.ID = ID
   frmAddEditPigDoc1.HeaderText = MapText("เแก้ไขข้อมูลสุกรคลอด")
   frmAddEditPigDoc1.ShowMode = SHOW_EDIT
   Load frmAddEditPigDoc1
   frmAddEditPigDoc1.Show 1
...
Private Sub Form_Activate()
   If Not m_HasActivate Then
      ...
      Call InitPigDoc1OrderBy(cboOrderBy)
...
'      End If
      ...
      m_InventoryDoc.DOCUMENT_TYPE = 5 'ใบเกิดหมู
...
Dim fmsTemp As JSFormatStyle
   ...
   Col.Width = 2115
   Col.Caption = MapText("เลขที่ใบเกิด")
      
   Set Col = GridEX1.Columns.Add '3
   Col.Width = 2055
   Col.Caption = MapText("วันที่เกิด")
