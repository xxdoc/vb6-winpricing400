...
Begin VB.Form frmPigDoc3 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin GridEX20.GridEX GridEX1 
         ...
         IntProp7        =   0
         ColumnsCount    =   2
         Column(1)       =   "frmPigDoc3.frx":27A2
         Column(2)       =   "frmPigDoc3.frx":286A
         FormatStylesCount=   5
         FormatStyle(1)  =   "frmPigDoc3.frx":290E
         FormatStyle(2)  =   "frmPigDoc3.frx":2A6A
         FormatStyle(3)  =   "frmPigDoc3.frx":2B1A
         FormatStyle(4)  =   "frmPigDoc3.frx":2BCE
         FormatStyle(5)  =   "frmPigDoc3.frx":2CA6
         ImageCount      =   0
         PrinterProperties=   "frmPigDoc3.frx":2D5E
      End
      ...
      Begin Threed.SSCommand cmdOK 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmPigDoc3.frx":3884
         ButtonStyle     =   3
      End
   End
End
Attribute VB_Name = "frmPigDoc3"
...
'   End If
   ...
   frmAddEditPigDoc3.HeaderText = MapText("เพิ่มข้อมูลการปรับยอดสุกร")
   frmAddEditPigDoc3.ShowMode = SHOW_ADD
   Load frmAddEditPigDoc3
   frmAddEditPigDoc3.Show 1
   
   OKClick = frmAddEditPigDoc3.OKClick
   
   Unload frmAddEditPigDoc3
   Set frmAddEditPigDoc3 = Nothing
...
'   End If
   ...
   frmAddEditPigDoc3.ID = ID
   frmAddEditPigDoc3.HeaderText = MapText("เแก้ไขข้อมูลการปรับยอดสุกร")
   frmAddEditPigDoc3.ShowMode = SHOW_EDIT
   Load frmAddEditPigDoc3
   frmAddEditPigDoc3.Show 1
...
'      End If
      ...
      m_InventoryDoc.DOCUMENT_TYPE = 9 'ใบปรับยอดสุกร
...
Private Sub InitFormLayout()
   ...
   Me.Caption = MapText("ปรับยอดสุกร")
