...
Begin VB.Form frmQueryCustomer 
   ClientHeight    =   6240
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10005
   Icon            =   "frmQueryCustomer.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSFrame SSFrame2 
         ...
         Begin GridEX20.GridEX GridEX1 
            ...
            IntProp7        =   0
            ColumnsCount    =   2
            Column(1)       =   "frmQueryCustomer.frx":27A2
            Column(2)       =   "frmQueryCustomer.frx":286A
            FormatStylesCount=   5
            FormatStyle(1)  =   "frmQueryCustomer.frx":290E
            FormatStyle(2)  =   "frmQueryCustomer.frx":2A6A
            FormatStyle(3)  =   "frmQueryCustomer.frx":2B1A
            FormatStyle(4)  =   "frmQueryCustomer.frx":2BCE
            FormatStyle(5)  =   "frmQueryCustomer.frx":2CA6
            ImageCount      =   0
            PrinterProperties=   "frmQueryCustomer.frx":2D5E
         End
      End
      ...
      Begin Threed.SSPanel pnlFooter 
         ...
         Begin Threed.SSCommand cmdOK 
            ...
            _Version        =   131073
            MousePointer    =   99
            MouseIcon       =   "frmQueryCustomer.frx":2F36
            ButtonStyle     =   3
         End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmQueryCustomer.frx":3250
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmQueryCustomer"
...
Dim Cm As CCustomer
   ...
   If Flag Then
      ...
      Cm.CUSTOMER_ID = -1
      Cm.CUSTOMER_CODE = PatchWildCard(txtSocCode.Text)
      Cm.CUSTOMER_NAME = PatchWildCard(txtMinimum.Text)
      Cm.CUSTOMER_GRADE = -1
      Cm.CUSTOMER_TYPE = -1
      Cm.BUSINESS_TYPE = -1
      Cm.OrderBy = 2
      Cm.OrderType = 1
      If Not glbDaily.QueryCustomer(Cm, m_Rs, ItemCount, IsOK, glbErrorLog) Then
...
'   End If
   ...
   If ShowMode = SHOW_ADD Then
      Set C = New CCustomer
      C.CUSTOMER_ID = TempID
      Call glbDaily.QueryCustomer(C, m_Rs, ItemCount, IsOK, glbErrorLog)
...
Private Sub InitFormLayout()
   HeaderText = MapText("ค้นหาข้อมูลลูกค้า")
   ...
   Call InitNormalLabel(lblSocCode, MapText("รหัสลูกค้า"))
   Call InitNormalLabel(lblMinimum, MapText("ชื่อลูกค้า"))
...
Dim RealIndex As Long
   ...
   Values(2) = RealIndex
   Values(3) = m_Customer.CUSTOMER_CODE
   Values(4) = m_Customer.CUSTOMER_NAME
   Exit Sub
