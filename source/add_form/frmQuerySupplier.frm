...
Begin VB.Form frmQuerySupplier 
   ClientHeight    =   6240
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   10005
   Icon            =   "frmQuerySupplier.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin Threed.SSFrame SSFrame2 
         ...
         Begin GridEX20.GridEX GridEX1 
            ...
            IntProp7        =   0
            ColumnsCount    =   2
            Column(1)       =   "frmQuerySupplier.frx":27A2
            Column(2)       =   "frmQuerySupplier.frx":286A
            FormatStylesCount=   5
            FormatStyle(1)  =   "frmQuerySupplier.frx":290E
            FormatStyle(2)  =   "frmQuerySupplier.frx":2A6A
            FormatStyle(3)  =   "frmQuerySupplier.frx":2B1A
            FormatStyle(4)  =   "frmQuerySupplier.frx":2BCE
            FormatStyle(5)  =   "frmQuerySupplier.frx":2CA6
            ImageCount      =   0
            PrinterProperties=   "frmQuerySupplier.frx":2D5E
         End
      End
      ...
      Begin Threed.SSPanel pnlFooter 
         ...
         Begin Threed.SSCommand cmdOK 
            ...
            _Version        =   131073
            MousePointer    =   99
            MouseIcon       =   "frmQuerySupplier.frx":2F36
            ButtonStyle     =   3
         End
      ...
      Begin Threed.SSCommand cmdSearch 
         ...
         _Version        =   131073
         MousePointer    =   99
         MouseIcon       =   "frmQuerySupplier.frx":3250
         ButtonStyle     =   3
      End
   ...
   End
End
Attribute VB_Name = "frmQuerySupplier"
...
Dim Col As JSColumn
   ...
   Col.Width = 2055
   Col.Caption = MapText("รหัสผู้ขาย")
   
   Set Col = GridEX1.Columns.add '4
   Col.Width = 7410
   Col.Caption = MapText("ชื่อผู้ขาย")
End Sub
...
Dim Cm As CSupplier
   ...
   If Flag Then
      ...
      Set Cm = New CSupplier
      Cm.SUPPLIER_ID = -1
      Cm.SUPPLIER_CODE = PatchWildCard(txtSocCode.Text)
      Cm.SUPPLIER_NAME = PatchWildCard(txtMinimum.Text)
      Cm.SUPPLIER_TYPE = cboPartType.ItemData(Minus2Zero(cboPartType.ListIndex))
      Cm.OrderBy = 3
      Cm.OrderType = 1
      If Not glbDaily.QuerySupplier(Cm, m_Rs, ItemCount, IsOK, glbErrorLog) Then
...
'   End If
   ...
   If ShowMode = SHOW_ADD Then
      Set C = New CSupplier
      C.SUPPLIER_ID = TempID
      Call glbDaily.QuerySupplier(C, m_Rs, ItemCount, IsOK, glbErrorLog)
...
Dim FeatureTypeID As Long
   ...
   If Not m_HasActivate Then
      ...
      Call LoadSupplierType(cboPartType)
...
Private Sub InitFormLayout()
   HeaderText = MapText("ค้นหาข้อผู้ขาย")
   ...
   Call InitNormalLabel(lblSocCode, MapText("รหัสผู้ขาย"))
   Call InitNormalLabel(lblMinimum, MapText("ชื่อผู้ขาย"))
   Call InitNormalLabel(lblPartType, MapText("ประเภทผู้ขาย"))
...
Dim RealIndex As Long
   ...
   Values(2) = RealIndex
   Values(3) = m_Supplier.SUPPLIER_CODE
   Values(4) = m_Supplier.SUPPLIER_NAME
   Exit Sub
