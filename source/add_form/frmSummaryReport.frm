...
Dim MI As CMenuItem
   ...
   ElseIf MasterMode = 2 Then
      ...
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 2-3", MapText("รายงานราคาประกาศหน้าโรง "), 4, 4)
      Node.Expanded = False
      
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 2-3", tvwChild, ROOT_TREE & " 2-3-1", MapText("รายงานราคาประกาศสินค้าหน้าโรง"), 1, 2)
         Node.Expanded = False
   
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 2-3", tvwChild, ROOT_TREE & " 2-3-2", MapText("รายงานราคาประกาศค่าขนส่ง"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 2-3", tvwChild, ROOT_TREE & " 2-3-3", MapText("รายงานโปรโมชั่นราคาสินค้า"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 2-3", tvwChild, ROOT_TREE & " 2-3-4", MapText("รายงานโปรโมชั่นราคาค่าขนส่ง"), 1, 2)
         Node.Expanded = False
   ...
   ElseIf MasterMode = 3 Then
      ...
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 3-1-2", MapText("รายงานข้อมูลลูกค้าแบบละเอียด"), 1, 2)
      Node.Expanded = False
   ...
   ElseIf MasterMode = 4 Then
      ...
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-1", MapText("รายงานรหัสสินค้าและวัตถุดิบ (ST001)"), 1, 2)
      Node.Expanded = False
      
'      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-3", MapText("รายงาน Stock Card สินค้า/วัตถุดิบ (ST002)"), 1, 2)
'      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-3-1", MapText("รายงาน Stock Card สินค้า/วัตถุดิบ (ST002)"), 1, 2)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-4", MapText("รายงาน Stock คงเหลือรายคลัง (ST003.1)"), 1, 2)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-4-1", MapText("รายงาน Stock คงเหลือรายวัตถุดิบ (ST003.2)"), 1, 2)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5", MapText("รายงาน Stock คงเหลือรวม (ST004)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-1-1", MapText("รายงาน Stock คงเหลือรวม แยกตามวันที่ (ST004-1)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-1", MapText("รายงานสรุปจำนวนการเคลื่อนไหว Stock (ST005)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-2", MapText("รายงานสรุปมูลค่าการเคลื่อนไหว Stock (ST006)"), 1, 2)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-3", MapText("รายงานการปรับยอด Stock (ST007)"), 1, 2)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-4", MapText("รายงานการปรับยอดรายคลัง (ST008)"), 1, 2)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-6", MapText("รายงานสรุปการเคลื่อนไหววัตถุดิบ (ST010)"), 1, 2)
      Node.Expanded = False
      
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-6-2", MapText("รายงานสรุปการเคลื่อนไหววัตถุดิบ แบบย่อ (ST010-2)"), 1, 2)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-7", MapText("รายงานสรุปการเคลื่อนไหววัตถุดิบ แยกตามประเภทลูกค้า(ST011)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-8", MapText("รายงานต้นทุนและมูลค่าขายตามสินค้า(ST012)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-5-9", MapText("รายงานต้นทุนมูลค่ารวมตามผลิต ประเภทลูกค้า(ST013)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-A", MapText("รายงานการรับเข้าวัตถุดิบ"), 4, 4)
      Node.Expanded = False
   
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-7", MapText("รายงานการซื้อวัตถุดิบ (RM001)"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-7-1", MapText("รายงานการซื้อวัตถุดิบ (MGP) (RM001-1)"), 1, 2)
         Node.Expanded = False
      
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-8", MapText("รายงานสรุปการซื้อวัตถุดิบ 1 (RM002.1)"), 1, 2)
         Node.Expanded = False
         ...
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-10", MapText("รายงานคิวรถเข้าเครื่องชั่ง (RM004)"), 1, 2)
         Node.Expanded = False
   
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-A-1", MapText("รายงานซื้อวัตถุดิบตามผู้ขาย (RM005)"), 1, 2)
         Node.Expanded = False
   
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-A-2", MapText("รายงานซื้อวัตถุดิบตามวัตถุดิบ (RM006)"), 1, 2)
         Node.Expanded = False
      
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-A-3", MapText("รายงานมูลค่าซื้อวัตถุดิบตามผู้ขาย (RM007)"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-A-4", MapText("รายงานซื้อวัตถุดิบตามประเภทวัตถุดิบ (RM008)"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-A-5", MapText("รายงานซื้อวัตถุดิบตามประเภทวัตถุดิบ แยกเป็นเดือน (RM009)"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-A", tvwChild, ROOT_TREE & " 4-A-6", MapText("รายงานซื้อวัตถุดิบตามผู้ขาย และวัตถุดิบ (RM010)"), 1, 2)
         Node.Expanded = False
         
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 4-B", MapText("รายงานการรับเข้า/เบิกวัสดุอุปกรณ์"), 4, 4)
      Node.Expanded = False
   
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-11", MapText("รายงานค่าใช้จ่ายการเบิกตามแผนก (IV001)"), 1, 2)
         Node.Expanded = False
      
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-12", MapText("รายงานค่าใช้จ่ายการเบิกตามค่าใช้จ่าย (IV002)"), 1, 2)
         Node.Expanded = False
   
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-12-1", MapText("รายงานการรับเข้าวัสดุ/รับเข้าทั่วไป (IV003)"), 1, 2)
         Node.Expanded = False
   
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-12-2", MapText("รายงานสรุปค่าใช้จ่ายการเบิกตามแผนก (IV004)"), 1, 2)
         Node.Expanded = False
   
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-12-3", MapText("รายงานค่าใช้จ่ายการเบิกตามแผนกรายวัน (IV005)"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-12-4", MapText("รายงานการซื้อประจำเดือน  (IV006)"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-12-5", MapText("รายงานค่าใช้จ่ายการเบิกตามแผนกรายวัน (IV007)"), 1, 2)
         Node.Expanded = False
         
         Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-12-6", MapText("รายงานค่าใช้จ่ายการเบิกตามบิลรายวัน (IV008)"), 1, 2)
         Node.Expanded = False
         
        Set Node = trvMaster.Nodes.add(ROOT_TREE & " 4-B", tvwChild, ROOT_TREE & " 4-12-7", MapText("รายงานใบคุมโครงการ   แสดงค่าใช้จ่ายการเบิกแยกตามโครงงาน(IV009)"), 1, 2)
         Node.Expanded = False
   ...
   ElseIf MasterMode = 6 Then
      ...
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 6-0-1", MapText("รายงาน LOGISTIC (PL006-0-1)"), 1, 2)
      Node.Expanded = False
...
'     Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-6", MapText("รายงานใบสูตรการผลิต (PD001)"), 1, 2)
'      Node.Expanded = False
'
'     Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-7", MapText("รายงานใบสั่งผลิต (PD002)"), 1, 2)
'      Node.Expanded = False
'
'      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-8", MapText("รายงานใบประเมินราคา (PD003)"), 1, 2)
'      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-18", MapText("รายงานสูตรการผลิต (PD001)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-9", MapText("รายงานการเทยา (PD004)"), 1, 2)
      Node.Expanded = False

       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-10", MapText("รายงานสรุปการผลิต (PD005)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-11", MapText("รายงานยอดใช้สำหรับผลิต (PD006)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-12", MapText("รายงานต้นทุนการผลิต (PD007)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-13", MapText("รายงานสรุปยอดใช้วัตถุดิบ (จริง) (PD008.1)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-13-1", MapText("รายงานสรุปยอดใช้วัตถุดิบ (สูตร) (PD008.2)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-14", MapText("รายงานสรุปยอดผลิตตามวัตถุดิบ (สูตร) (PD009.1)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-14-0", MapText("รายงานสรุปยอดผลิตตามวัตถุดิบ (จริง) (PD009.2)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-14-1", MapText("รายงานสรุปยอดผลิตตามจริง (PD009.3)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-14-2", MapText("รายงานสรุปยอดผลิตตามจริงมูลค่าตามวัตถุดิบ (PD009.4)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-15", MapText("รายงานยอดใช้วัตถุดิบตามผลิตภัณฑ์ (PD010)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-16", MapText("รายงานยอดผลิตตามวัตถุดิบ (PD011)"), 1, 2)
      Node.Expanded = False
   
       Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-17", MapText("รายงานสรุปจำนวนการใช้วัตถุดิบตามสินค้า (PD012)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-19", MapText("รายงานค่าใช้จ่ายไซโล ตามวัตถุดิบ (PD013)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 8-20", MapText("รายงานสรุปยอดการใช้วัตถุเพื่อผลิตแยกตามวัตถุดิบ และ เดือนผลิต(PD014)"), 1, 2)
      Node.Expanded = False
   ...
   ElseIf MasterMode = 10 Then
      ...
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 10-0-1", MapText("รายงาน ยอดขายตามพนักงานขาย ลูกค้า สินค้า (COM001)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 10-0-2", MapText("รายงาน ยอดขายตามพนักงานขาย + เพิ่มหนี้ลดหนี้ + %ขาย (COM002)"), 1, 2)
      Node.Expanded = False

      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 10-0-3", MapText("รายงาน ค่าคอมมิชชั่นของ ฟรีแลนซ์ ตามยอดรับชำระหนี้  (COM003)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 10-0-4", MapText("รายงานข้อมูลการขายของฟรีแลนซ์ เรียงตามลูกค้า และค่า INCENTIVE (COM004)"), 1, 2)
      Node.Expanded = False
   ...
   ElseIf MasterMode = 9 Then
      ...
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 9-1", MapText("รายงานรับเข้าสินค้า "), 4, 4)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE & " 9-1", tvwChild, ROOT_TREE & " 9-1-1", MapText("รายงานการบรรจุสินค้า (IW001)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 9-2", MapText("รายงานจ่ายออกสินค้า"), 4, 4)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE & " 9-2", tvwChild, ROOT_TREE & " 9-2-1", MapText("รายงานการจ่ายอาหารสำเร็จรูป (EW001)"), 1, 2)
      Node.Expanded = False
      
'      Set Node = trvMaster.Nodes.add(ROOT_TREE & " 9-2", tvwChild, ROOT_TREE & " 9-2-1", MapText("รายงานการจ่ายอาหารสำเร็จรูป (EW001)"), 1, 2)
'      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE & " 9-2", tvwChild, ROOT_TREE & " 9-2-2", MapText("รายงานการจ่ายอาหารสำเร็จรูป แยกตามประเภท (EW002)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 9-3", MapText("รายงานคลังสินค้า"), 4, 4)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE & " 9-3", tvwChild, ROOT_TREE & " 9-3-1", MapText("รายงาน KPI (WH001)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE & " 9-3", tvwChild, ROOT_TREE & " 9-3-2", MapText("รายงานคำนวนอายุอาหาร (WH002)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE & " 9-3", tvwChild, ROOT_TREE & " 9-3-3", MapText("รายงาน STOCK CARD คลังสินค้าสำเร็จรูป (WH003)"), 1, 2)
      Node.Expanded = False
      
      Set Node = trvMaster.Nodes.add(ROOT_TREE & " 9-3", tvwChild, ROOT_TREE & " 9-3-4", MapText("รายงาน STOCK CARD คลังสินค้าสำเร็จรูป รายล๊อต (WH004)"), 1, 2)
      Node.Expanded = False
    ...
    ElseIf MasterMode = 11 Then
      ...
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 2-1", MapText("รายงานราคาประกาศสินค้าหน้าโรง"), 1, 2)
      Node.Expanded = False
   
      Set Node = trvMaster.Nodes.add(ROOT_TREE, tvwChild, ROOT_TREE & " 2-2", MapText("รายงานราคาประกาศค่าขนส่ง"), 1, 2)
      Node.Expanded = False
   End If
End Sub
...
Private Sub InitFormLayout()
   ...
   Call InitMainButton(cmdSelCusGrade, MapText("เลือกระดับลูกค้า"))
   Call InitMainButton(cmdSelCus, MapText("เลือกลูกค้า"))
   ...
   Call InitCheckBox(chkCommit(0), "งานเสร็จแล้ว")
   ...
   ElseIf ControlType = "D" Then
      ...
      ElseIf Param1 = "FROM_WEEK" Or Param1 = "FROM_WEEK_DATE" Then
       ...
       ElseIf Param1 = "TO_WEEK_DATE" Or Param1 = "TO_SUP_DATE" Then
           ...
           Else
            uctlGenericDate(DateIdx).ShowDate = getBeginDay("MON") + 6 ' เป็น 1 สัปดาห์
           End If
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ระดับลูกค้า"))
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "รหัสลูกค้า", , "SHOW_CODE")
   Call LoadControl("CH", cboGeneric(0).Width, True, "ประเภท", , "SHOW_TYPE")
   Call LoadControl("CH", cboGeneric(0).Width, True, "ระดับ", , "SHOW_LEVEL")
   Call LoadControl("CH", cboGeneric(0).Width, True, "ที่อยู่", , "SHOW_ADDRESS")
   Call LoadControl("CH", cboGeneric(0).Width, True, "เครดิตวัน", , "SHOW_CREDIT")
   Call LoadControl("CH", cboGeneric(0).Width, True, "วงเงิน", , "SHOW_CREDIT_LIMIT")
   Call LoadControl("CH", cboGeneric(0).Width, True, "พนักงานขาย", , "SHOW_SALE")
...
Dim Offset As Long
   ...
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "EMP_CODE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รหัสพนักงานฟรีแลนซ์"))
   
   '2 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "EMP_NAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ชื่อพนักงานฟรีแลนซ์"))

   '2 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "EMP_LASTNAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("นามสกุลพนักงานฟรีแลนซ์"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ชื่อวัตถุดิบ"))

   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 1, "UNIT_COUNT")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หน่วยนับ"))
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "สำหรับตรวจสอบ", , "FOR_CHECK")
   Call LoadControl("CH", cboGeneric(0).Width, True, "เฉพาะเบอร์ที่ไม่ยกเลิก", , "CANCEL_FLAG")
   
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "COLUMN2")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ค.กว้าง คอลัมน์ 2"))
   
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "COLUMN3")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ค.กว้าง คอลัมน์ 3"))
   
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "COLUMN4")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ค.กว้าง คอลัมน์ 4"))
   
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "COLUMN5")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ค.กว้าง คอลัมน์ 5"))
   
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "COLUMN6")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ค.กว้าง คอลัมน์ 6"))
   
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "COLUMN7")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ค.กว้าง คอลัมน์ 7"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("LOT การผลิต"))
...
'   '3 =============================
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ประเภทการบรรจุ"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากรหัสวัตถุดิบ"))
   
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "TO_PART_NO")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงรหัสวัตถุดิบ"))
...
'   Call LoadControl("L", lblGeneric(0).Width, True, MapText("สถานะรายการ"))
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("คำรายละเอียด(15)"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากสถานที่จัดเก็บ"))
   
   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 3, "LOCATION_ID2", "LOCATION_NAME2")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงสถานที่จัดเก็บ"))
...
'   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงรหัสลูกค้า"))
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ค่าถุง/ตัน"))
   
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 2, True, "", , "OH_GRAIN", , "OH_GRAIN", , "850")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("OH (เม็ด)/ตัน"))
   
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 2, True, "", , "OH_POWDER", , "OH_POWDER", , "650")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("OH (ผง)/ตัน"))
   
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 2, True, "", , "OH_NC_GRAIN", , "OH_NC_GRAIN", , "1000")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("OH นำโชค (เม็ด)/ตัน"))
   
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 2, True, "", , "OH_NC_POWDER", , "OH_NC_POWDER", , "850")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("OH นำโชค (ผง)/ตัน"))
   
   If TempKey = "Root F-1-8" Then
      Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงชื่อลูกค้า", , "SHOW_CUS_NAME")
...
Dim Offset As Long
   ...
   If TempKey = "Root A-7-2" Then
      Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงชื่อสินค้า", , "SHOW_PART_NO_FLAG")
      Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงรายการที่ปรับเปลี่ยนราคา", , "SHOW_EDIT_PRICE_FLAG")
   End If
...
Dim Offset As Long
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงรายละเอียดค่าขนส่ง", , "FLAG_DELIVERY_DETAIL")
...
Dim Offset As Long
   ...
   If TempKey = "Root " & "5-2-1-1" Then
      Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงสถานที่จัดส่ง", , "FLAG_DELIVERY_CUS")
   End If
...
'1 =============================
 Call LoadControl("T", txtGeneric(0).Width \ 1.5, True, "", , "EMP_CODE")
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "สรุป Collumn", , "SUMMARY_COLLUMN")
   Call LoadControl("CH", cboGeneric(0).Width, True, "สรุป Row", , "SUMMARY_ROW")
...
Dim Offset As Long
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงค่าขนส่ง", , "TRANSPORT_FLAG")
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ประเภทการขาย"))
      ...
      Call LoadControl("L", lblGeneric(0).Width, True, MapText("สาขา"))
      
      Call LoadControl("C", cboGeneric(0).Width, True, "", 5, "ACCOUNT_ID", "ACCOUNT_ID_NAME")
      Call LoadControl("L", lblGeneric(0).Width, True, MapText("เลขที่บัญชี"))
   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 6, "ORDER_BY")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("เรียงตาม"))
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงรายการสินค้า", , "FLAG_SHOW_PART_NO")
   Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงสถานที่จัดส่ง", , "FLAG_DELIVERY_CUS")
...
'   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากเครดิต"))
'
'   '1 =============================
'   Call LoadControl("T", txtGeneric(0).Width / 2, True, "", , "TO_CREDIT")
'   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงเครดิต"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("เซตของสินค้า"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("มูลค่า/น้ำหนัก"))
...
Dim Offset As Long
   ...
   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "FROM_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากวันที่ขนส่ง"))

   '2 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "TO_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงวันที่ขนส่ง"))

Call LoadControl("T", txtGeneric(0).Width \ 2, True, "", , "TRUCK_NO", , "TRUCK_NO")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ทะเบียนรถ"))
   
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "SUPPLIER_CODE_TRANSPORT", , "SUPPLIER_CODE_TRANSPORT")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รหัสซัพ ฯรถขนส่ง"))
   ...
   Call LoadControl("CH", chkCommit(0).Width, True, "ใช้แบบฟอร์ม", , "USE_FORM_FLAG", "ใช้แบบฟอร์ม")
   Call LoadControl("CH", chkCommit(0).Width, True, "ส่งลูกค้า", , "CUSTOMER_ONLY_FLAG", "เฉพาะรถขนส่ง")
   Call LoadControl("CH", chkCommit(0).Width, True, "ใบวางบิลส่งบัญชี", , "INVOICE_FLAG", "ใบวางบิล")
   Call LoadControl("CH", chkCommit(0).Width, True, "สรุปการจ่ายค่าขนส่ง", , "SUMMARY_DOC_FLAG", "สรุปการจ่ายค่าขนส่ง")
   Call LoadControl("CH", chkCommit(0).Width, True, "ใบสำคัญจ่าย", , "PAYMENT_VOUCHER_FLAG", "ใบสำคัญจ่าย")
   Call LoadControl("CH", chkCommit(0).Width, True, "ใบสำคัญโอนบัญชี", , "ACCOUNT_TRANSFER_FLAG", "ใบสำคัญโอนบัญชี")
   Call LoadControl("CH", chkCommit(0).Width, True, "ใช้คอลัมน์หักค่าขนส่ง", , "COLUMN_DEDUC_FLAG", "ใช้คอลัมน์หักค่าขนส่ง")
   Call LoadControl("CH", chkCommit(0).Width, True, "ใช้คอลัมน์เพิ่มค่าขนส่ง", , "ACCOUNT_ADD_FLAG", "ใช้คอลัมน์เพิ่มค่าขนส่ง")
   Call LoadControl("CH", chkCommit(0).Width, True, "แสดงชื่อลูกค้าในใบวางบิล", , "SHOW_CUS_NAME_FLAG", "แสดงชื่อลูกค้าในใบวางบิล")
...
Dim Offset As Long
   ...
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "SUPPLIER_CODE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รหัสซัพ ฯ"))
...
Dim Offset As Long
   ...
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "SUPPLIER_CODE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รหัสซัพพ ฯ"))
...
Dim Offset As Long
   ...
   Call LoadControl("CH", chkCommit(0).Width, True, "ยอดยกมานับจากต้นเดือน", , "BALANCE_FLAG")
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รูปแบบช่วงอายุหนี้"))
   
   Call LoadControl("CH", chkCommit(0).Width, True, "เลือกเฉพาะเกินดิว", , "OVERDUE_FLAG")
   Call LoadControl("CH", chkCommit(0).Width, True, "รวมยอดใน DUE", , "SUM_INDUE_FLAG")
...
'   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รูปแบบช่วงอายุหนี้"))
   ...
   Call LoadControl("CH", chkCommit(0).Width, True, "เลือกเฉพาะเกินดิว", , "OVERDUE_FLAG")
   Call LoadControl("CH", chkCommit(0).Width, True, "รวมยอดใน DUE", , "SUM_INDUE_FLAG")
'   Call LoadControl("CH", chkCommit(0).Width, True, "ไม่แสดงยอดใน DUE", , "HIDE_DUE_FLAG")
...
''   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ระดับลูกค้า"))
   ...
   Call LoadControl("CH", chkCommit(0).Width, True, "เลือกเฉพาะเกินวงเงินหรือวงวัน", , "OVERDUE_FLAG")
    
    Call LoadControl("CH", chkCommit(0).Width, True, "แสดงรายละเอียด", , "SHOW_DETAIL")
    Call LoadControl("CH", chkCommit(0).Width, True, "สรุป", , "SUM_FLAG")
    
'    Call LoadControl("CH", chkCommit(0).Width, True, "แสดงการติดตามแนว Column", , "SHOW_COLUMN_FLAG")
'
'    Call LoadControl("CH", chkCommit(0).Width, True, "แสดงการติดตามแนว Row", , "SHOW_ROW_FLAG")
'    Call LoadControl("CH", chkCommit(0).Width, True, "เฉพาะพนักงานที่ยังไม่ลาออก", , "SHOW_EMP_RESIGN_FLAG")
...
'   2 =============================
   ...
   '4 =============================
   Call LoadControl("CH", cboGeneric(0).Width, True, "สรุปรายเดือน", , "SUM_MONTH")
   Call LoadControl("CH", cboGeneric(0).Width, True, "สรุปรายเดือนมีรายละเอียด", , "SUM_MONTH_DETAIL")
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("สถานะ"))
   
   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 3, "EMP_SEX")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("เพศ"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขใบยืม"))

   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "LENDER")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ผู้ยืม"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ชื่อสินค้า"))
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หน่วยวัด"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขแพคเกจ"))
   
   '2 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "SOC_NAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ชื่อแพคเกจ"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วันที่ประกาศ"))
   
      '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "BETWEEN_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ช่วงวันที่มีผล"))
   
   '3 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 2, True, "", , "WORKS_PRICE_CODE", , "WORKS_PRICE_CODE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขเพจแกจ"))

   '3 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 1, True, "", , "PART_NO", , "PART_NO")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รหัสสินค้า/บริการ"))
...
Dim Offset As Long
   ...
   If TempKey = "Root 2-3-2" Then
      Call LoadControl("CH", chkCommit(0).Width, True, "ข้อมูลนำไปใช้ IMPORT ใหม่", , "FOR_IMPORT_FLAG")
   End If
...
'1 =============================
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขสูตร"))

   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "FORMULA_DESC")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รายละเอียดสูตร"))

   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 1, "FORMULA_TYPE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ประเภทสูตร"))
   
   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "FORMULA_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วันที่สร้างสูตร"))

   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 2, "APPROVED_BY")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("สร้างโดย"))
   
   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 3, "FORMULA_ITEM")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ผลิตภัณฑ์ที่สร้าง"))
...
'1 =============================
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขงาน"))

   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "JOB_DESC")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รายละเอียดงาน"))
'1 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "BATCH_NO")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขแบท"))
   
   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "JOB_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วันที่สั่งผลิต"))

   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "START_JOB")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วันที่เริ่มงาน"))

   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "FINISH_JOB")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วันที่เสร็จงาน"))

   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 1, "APPROVED_BY")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("อนุมัติโดย"))
   
   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 2, "RESPONSE_BY")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รับผิดชอบโดย"))
   
   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 3, "PROCESS_ID", "PROCESS_NAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("โปรเซส"))
   
   '3 =============================
   Call LoadControl("C", cboGeneric(0).Width, True, "", 4, "JOB_STATUS")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("สถานะงาน"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขสินค้า"))
...
'1 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "JOB_NO")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขใบประเมิน"))

   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "JOB_DESC")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รายละเอียด"))
'1 =============================
   Call LoadControl("T", txtGeneric(0).Width, True, "", , "BATCH_NO")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลขแบท"))
   ...
   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "JOB_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วันที่ประเมิน"))
...
'   Call LoadControl("L", lblGeneric(0).Width, True, MapText("สถานะงาน"))
  ...
  ' Call LoadControl("L", lblGeneric(0).Width, True, MapText("'งานเสร็จ"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ชุดข้อมูลสินค้า"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("พารามิเตอร์"))
...
Dim Offset As Long
   ...
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "PRINT_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วันที่ผลิต"))
   
   Call LoadControl("C", cboGeneric(0).Width, True, "", 1, "HEAD_PACK_NO", "HEAD_PACK_NAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("เครื่องบรรจุ"))
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("เรียงจาก"))
''
   Call LoadControl("CH", cboGeneric(0).Width, True, "ไม่แสดงข้อมูล", , "NOT_SHOW")
...
Dim Offset As Long
   ...
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "PRINT_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วันที่จ่ายอาหาร"))
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ขนาดชื่อลูกค้า(15)"))
   
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "LIMIT_PART_NAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ขนาดชื่อสินค้า(25)"))
...
Dim Offset As Long
   ...
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "FROM_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากวันที่จ่ายอาหาร"))
   
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "TO_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงวันที่จ่ายอาหาร"))
...
''
''   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "LIMIT_PART_NAME")
''   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ขนาดชื่อสินค้า(15)"))
''
''''
''   Call LoadControl("CH", cboGeneric(0).Width, True, "ไม่แสดงข้อมูล", , "NOT_SHOW")
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("หมายเลข"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ระดับผู้ขาย"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("สถานะเช็ค"))
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จ่ายให้กับ"))
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ขนาดชื่อบัญชี"))
   
   Call LoadControl("CH", chkCommit(0).Width, True, "ไม่ต้องลงวันที่", , "DATE_FLAG")
...
'   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงรหัสลูกค้า"))
   ...
   Call LoadControl("CH", chkCommit(0).Width, True, "ตัดหนี้เมื่อออกเช็ค", , "EFFECTIVE_FLAG")
...
'   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงรหัสลูกค้า"))
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "ตัดหนี้เมื่อออกเช็ค", , "EFFECTIVE_FLAG")
...
Dim Offset As Long
   ...
   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "FROM_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากวันที่ PO"))
   
   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "TO_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงวันที่ PO"))
...
Dim Offset As Long
   ...
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "PART_NO", , "PART_NO")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("วัตถุดิบ"))
   
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "PRINT_DATE") ' เอาวันที่    "จากวันที่ PO"  เป็น จากวันที่รับ PO ใน CReportAP017
   Call LoadControl("L", lblGeneric(0).Width, True, MapText(" วันที่พิมพ์ "))
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ประเภท PO"))
   
   Call LoadControl("C", cboGeneric(0).Width, True, "", 4, "PO_CLOSE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("การปิด PO"))
   ...
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "LIMIT_PART_DESC")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ความยาววัตถุดิบ(25)"))
   
   Call LoadControl("T", txtGeneric(0).Width / 1.5, True, "", , "LIMIT_SUPPLIER_NAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ความยาวชื่อผู้ขาย(25)"))
   
   Call LoadControl("CH", chkCommit(0).Width, True, "แสดงหน่วย", , "SHOW_UNIT_NAME_FLAG")
   Call LoadControl("CH", chkCommit(0).Width, True, "สถานะเอกสาร", , "SHOW_STATUS_PO_FLAG")
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("การอนุมัติ PO"))
...
Dim Offset As Long
   ...
   Call LoadControl("CH", chkCommit(0).Width, True, "แสดงหน่วย", , "SHOW_UNIT_NAME_FLAG")
   Call LoadControl("CH", chkCommit(0).Width, True, "สรุป", , "SUMMARY_MODE")
...
Dim Offset As Long
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "ใบรับเข้าวัตถุดิบ", , "DOCUMENT_TYPE1")
   Call LoadControl("CH", cboGeneric(0).Width, True, "ใบรับเข้าวัสดุอุปกรณ์", , "DOCUMENT_TYPE19")
   Call LoadControl("CH", cboGeneric(0).Width, True, "ใบรับเข้าจ่ายออกวัสดุอุปกรณ์", , "DOCUMENT_TYPE20")
   Call LoadControl("CH", cboGeneric(0).Width, True, "ใบรับเข้าทั่วไป", , "DOCUMENT_TYPE23")
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงวันที่รับเข้า"))
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "ประมาณการล่วงหน้า", , "SHOW_USE_PLAN")
   Call LoadControl("CH", cboGeneric(0).Width, True, "ยอดรับจริง", , "SHOW_RX_ACTUAL")
...
Dim Offset As Long
   ...
   Call LoadControl("CH", cboGeneric(0).Width, True, "ไม่แสดงช่องส่วนลด", , "HIDE_DISCOUNT")
   Call LoadControl("CH", cboGeneric(0).Width, True, "เฉพาะพนักงานขายในตาราง Organize", , "ONLY_HAVE_ORGANIZE")
   Call LoadControl("CH", cboGeneric(0).Width, True, "เฉพาะประเภทสินค้าที่คิดคอม", , "ONLY_TYPE_COM")
...
Dim Offset As Long
   ...
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากวันที่มีผล"))
   
   Call LoadControl("C", cboGeneric(0).Width, True, "", 2, "CUSTOMER_GRADE", "CUSTOMER_GRADE_NAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ระดับลูกค้า"))
   
   Call LoadControl("T", txtGeneric(0).Width / 2, False, "", , "INTEREST_RATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("% ดอกเบี้ยล่าช้าต่อปี"))
...
Dim Offset As Long
   ...
   Call LoadControl("C", cboGeneric(0).Width \ 2, False, "", 1, "MONTH_ID", "MONTH_NAME")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("เดือนขาย"))
      
   Call LoadControl("T", txtGeneric(0).Width / 2, False, "", , "YEAR_NO")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ปีขาย"))
   
   Call LoadControl("T", txtGeneric(0).Width \ 1.5, True, "", , "FREELANCE_CODE", , "FREELANCE_CODE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รหัสฟรีแลนซ์"))
   
      '1 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 2, True, "", , "FROM_FREELANCE_CODE", , "FREELANCE_CODE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากรหัสฟรีแลนซ์"))
   
   '1 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 2, True, "", , "TO_FREELANCE_CODE", , "FREELANCE_CODE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงรหัสฟรีแลนซ์"))
      '1 =============================
   Call LoadControl("T", txtGeneric(0).Width \ 1.5, True, "", , "CUSTOMER_CODE", , "CUSTOMER_CODE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("รหัสลูกค้า"))
  ...
  Call LoadControl("CH", cboGeneric(0).Width, True, "สรุปตาม พนักงานขาย และลูกค้า", , "ONLY_CUS")
   Call LoadControl("CH", cboGeneric(0).Width, True, "สรุปตาม พนักงานขาย และลูกค้า ใบเสร็จ", , "ONLY_CUS_DOC")
   
   Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงรหัสเต็มสินค้า", , "SHOW_PART_NO")
   
   Call LoadControl("CH", cboGeneric(0).Width, True, "แสดงชื่อเต็มลูกค้า", , "SHOW_CUSTOMER_NAME")
...
Dim Offset As Long
   ...
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "FROM_DUE_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("จากวันที่ DUE"))
      
   '1 =============================
   Call LoadControl("D", uctlGenericDate(0).Width, True, "", , "TO_DUE_DATE")
   Call LoadControl("L", lblGeneric(0).Width, True, MapText("ถึงวันที่ DUE"))
   ...
   Call LoadControl("CH", chkCommit(0).Width, True, "เปรียบเทียบ TARGET-ACTUAL", , "COMPARE_TARGET_ACTUAL_FLAG")
   Call LoadControl("CH", chkCommit(0).Width, True, "เลือกเฉพาะที่มียอดหนี้คงเหลือ", , "BALANCE_SUMMIT_FLAG")
   Call LoadControl("CH", chkCommit(0).Width, True, "เลือกเฉพาะที่มียอด ACTUAL", , "BALANCE_ACTUAL_FLAG")
'   Call LoadControl("CH", chkCommit(0).Width, True, "แสดงค่าส่วนต่าง ACTUAL", , "DIFF_ACTUAL_FLAG")
