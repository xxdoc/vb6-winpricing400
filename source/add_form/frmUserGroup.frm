...
Dim id As Long
   ...
   If Not glbAdmin.DeleteUserGroup(id, IsOK, True, glbErrorLog) Then
...
Dim ItemCount As Long
   ...
   If Flag Then
      ...
      m_UserGroup.GROUP_NAME = PatchWildCard(txtGroupName.Text)
...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = MapText("ข้อมูลกลุ่มผู้ใช้งาน")
