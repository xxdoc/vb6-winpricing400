...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      frmAddEditExportItem.HeaderText = MapText("เพิ่มรายการเบิกจ่าย")
...
Dim OKClick As Boolean
   ...
   If TabStrip1.SelectedItem.Index = 1 Then
      ...
      frmAddEditExportItem.COMMIT_FLAG = m_InventoryDoc.COMMIT_FLAG
      Set frmAddEditExportItem.TempCollection = m_InventoryDoc.ImportExports
      frmAddEditExportItem.HeaderText = MapText("แก้ไขรายการเบิกจ่าย")
      frmAddEditExportItem.ParentShowMode = ShowMode
...
Private Sub InitFormLayout()
   ...
   Call InitCheckBox(chkSaleFlag, MapText("เบิกขาย"))
   ...
   TabStrip1.Tabs.add().Caption = MapText("รายการเบิกวัตถุดิบ")
End Sub
