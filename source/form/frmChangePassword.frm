...
Begin VB.Form frmChangePassword 
   ...
   Begin Threed.SSFrame SSFrame1 
      ...
      Begin prjFarmManagement.uctlTextBox txtOldPassword 
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtNewPassword1 
         Height          =   435
         Left            =   1830
         TabIndex        =   2
         Top             =   1830
         ...
         _ExtentY        =   767
      End
      Begin prjFarmManagement.uctlTextBox txtNewPassword2 
         Height          =   435
         Left            =   1830
         TabIndex        =   3
         Top             =   2280
...
Dim IsCanChange As Boolean
   ...
   If Not glbAdmin.ChangePassword(glbUser.REAL_USER_ID, txtOldPassword.Text, txtNewPassword1.Text, IsCanChange, glbErrorLog) Then
...
Private Sub InitFormLayout()
   ...
   pnlHeader.Caption = MapText("เปลี่ยนรหัสผ่าน")
