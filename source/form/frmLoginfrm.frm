...
'      Call cmdPrint_Click
   ...
   ElseIf Shift = 0 And KeyCode = 123 Then
      Call AddMemoNote
      KeyCode = 0
   ElseIf Shift = 0 And KeyCode = 20 Then 'CHECK CAPSLOCK
    lblCapslock.Caption = CheckCapsLock
      KeyCode = 0
   End If
End Sub
